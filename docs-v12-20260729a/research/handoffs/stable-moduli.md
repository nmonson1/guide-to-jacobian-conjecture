...
task. “Accepted as project input” means use the exact claim at its cited
scope; it does not mean externally reviewed. No Program 4 input below has
independent specialist review recorded.
...
The framed-stack record in item 4 is `recorded`; the other rows are `proof
offered`. These are project-use statuses, not independent review.
