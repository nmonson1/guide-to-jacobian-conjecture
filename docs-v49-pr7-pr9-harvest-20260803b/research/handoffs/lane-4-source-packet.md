...
- `lane4-f4-contract-20260803-v1/README.md` — `8718f55a3a15f214317183f1ac942e8add18db9a3e993d9245d8fb5d2c14e7be`
- `lane4-f4-contract-20260803-v1/F4_INPUT_CONTRACT.md` — `d8bf85998e9377cba79e551b381ee0ba7dd12f990b78ce39854b551a3bddf61a`
- `lane4-f4-contract-20260803-v1/f4-contract.schema.json` — `65291074944b53aa1581ab4e93694c384987a0115fb59e1802ba63a9bcb82340`
- `lane4-f4-contract-20260803-v1/verify_contract_and_routing.py` — `6a64525606f8e21897befcb5a8cf71f2715eb116a8cd8218bebaecd2d11f9bc6`
...
- `lane4-quartic-endgame-20260802-v1/proofs/10-structural-repairs-and-z2.tex` — `34965b4639e53009826d6fe5c5e4aa8f88b8f8f53dcaf1d672759613be62a92f`
...
# Lane 4 structural repair and Q4-F4 contract

This packet preserves the useful mathematical content harvested from public
site PR 8 at exact head
100caa6bdbff5d532232b39d69249ce6a08214c9. It was independently checked
against the canonical Program 2 manuscript before integration.

## What was integrated

- The leading homogeneous Jacobian condition now forces projective image
  dimension at most one.
- The leading-image factorization chooses the normalization of the actual
  image curve first. It no longer treats relative algebraic closure as proof
  that an arbitrary parametrization is birational.
- Target span three now has an explicit bridge into the nondegenerate curve
  case.
- The four structural loci proof now spells out the composite and
  fixed-component valuation arguments, including where nonnegativity of
  residue orders is and is not available.

The complete proofs live in ../../manuscripts/02-low-degree/main.tex. The
checker in this directory tests only their finite arithmetic skeleton and
the shape of the separate Q4-F4 input contract; it is not a proof of the
geometric statements.

## What remains open

The surviving weighted-inflection branch Q4-F4 still lacks a reconstructible
exact input packet. F4_INPUT_CONTRACT.md and f4-contract.schema.json state the
minimum payload needed before a D6/D5 elimination can be audited. No missing
formula was inferred from prose, and this packet contains no claimed F4
elimination.
...
The source PR remains an intake artifact, not an accepted replacement for
the repository. Only the repairs recomputed in the canonical manuscript and
the fail-closed contract were harvested. Historical case-tree prose and any
claim that Q4-F4 has already been solved were not imported.
</code></pre>
