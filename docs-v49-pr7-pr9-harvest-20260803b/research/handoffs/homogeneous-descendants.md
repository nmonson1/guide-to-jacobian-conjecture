...
<p class="claim-tag">Program 5 · Updated 3 August 2026</p>
...
[Retained working mathematics](../working-mathematics/programs/homogeneous-descendants.md) · [Current proof sources](../proof-sources/05-homogeneous-descendants/main.md) · [Machine-readable release metadata](release.json)
