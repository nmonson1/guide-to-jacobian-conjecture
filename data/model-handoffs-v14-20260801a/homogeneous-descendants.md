...
[working paper](../../assets/manuscripts/{{MANUSCRIPT_05}}),
...
A separate exact equivariant export now enlarges one natural affine test
from a 20-dimensional row-zero slice to the full 22-dimensional tangent
space of the rank-at-most-six locus at \(P_0=-d^2e_a\). The row-zero space
is contained in the rank-six tangent, and
\(\Lambda_4(\mathcal O_4(P))=1\) on all 22 affine tangent directions. A
two-dimensional transverse section lifts through second order. After all 66
quadratic tangent-kernel coefficients are allowed, its cubic system has rank
15 and augmented rank 16; a two-coordinate left-null witness pairs with the
right-hand side as \(-256/3\). Thus this selected plane is intrinsically
obstructed at cubic order. The 115-dimensional equivariant calculation is an
independent sanity check, not the larger 726/109/75 operation audit.
...
| --- | --- | --- |
| 1 | The credited public eleven-variable map is a degree-three Keller counterexample with 52 nonlinear monomial terms, determinant `-2`, and the displayed collision. It is an external starting input, not derived by the suspension theorem. | [`JCG-A39E3CCD`](../../claims/JCG-A39E3CCD.md) · [statement and formulas used here](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=1) |
| 2 | If `K=X+Q+C` and the cubic coordinate span has dimension `r`, the rank-sensitive construction gives a cubic-homogeneous counterexample in dimension `n+r+1` and lifts a collision. For the eleven-variable input, `r=7`, hence dimension 19. | [`JCG-38CAAB66`](../../claims/JCG-38CAAB66.md) · [proof](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=2) |
| 3 | For the fixed nineteen-variable tensor only, its generic nonlinear Jacobian has Jordan type `(18,1)`. | [`JCG-7AFFFF85`](../../claims/JCG-7AFFFF85.md) · [proof](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=5) |
| 4 | The displayed 38-variable cotangent/symmetric double is polynomially stably right-equivalent to the nineteen-variable map times an identity factor and induces the same generic function-field cover. | [`JCG-301AAE68`](../../claims/JCG-301AAE68.md) · [proof](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=12) |
| 5 | For that fixed double, the generic Hessian Jordan type is `(35,2,1)`. Its explicit inverse-ray formula makes every stated Laplacian term nonzero at every order. This is not a general Hessian-nilpotent nonvanishing theorem. | [`JCG-57051B08`](../../claims/JCG-57051B08.md), [`JCG-D55D3D6A`](../../claims/JCG-D55D3D6A.md) · [Hessian proof](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=7) · [all-order Laplacian proof](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=14) |
| 6 | For the fixed nineteen-variable tensor and the stated full-rank square-zero pairing model, `52 <= N_pair <= 110`; the explicit 110-variable map is a stable presentation of the nineteen-variable map. No global minimum is asserted. | [`JCG-263402AA`](../../claims/JCG-263402AA.md), [`JCG-99288D5E`](../../claims/JCG-99288D5E.md) · [lower and upper proofs](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=9) |
| 7 | On the specified full-kernel pencil chart with `det T != 0`, regularity is equivalent to `a_7 != 0`; after the displayed linear change, the parameter space is `C lambda ⊕ Sym^6(C^2)` with the stated determinant invariant. | [`JCG-2EC7F92F`](../../claims/JCG-2EC7F92F.md) · [proof](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=17) |
| 8 | Exactly thirty enumerated full-kernel samples over `F_7`, `F_11`, and `F_13` are first-normally obstructed. This finite sample is evidence only; it does not imply characteristic-zero nowhere-vanishing. | [`JCG-86F5C9FA`](../../claims/JCG-86F5C9FA.md) · [finite sample calculation](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=18) |
| 9 | At the fixed nineteen-to-eighteen compression point, the affine row-killing family has dimension 109, including a proved 75-dimensional triangular-automorphism subspace; the residual tangent quotient has dimension 20. Other row-killers are not automatically automorphisms. | [`JCG-F245F636`](../../claims/JCG-F245F636.md) · [proof](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=18) |
| 10 | On the complete displayed six-dimensional transversal, the rank-at-most-six cone is the reduced union `V(u_3,u_5) ∪ V(u_0,u_3) ∪ V(u_2,u_5)`, and the quartic obstruction is identically `-1`; no point of this transversal lifts through quartic order. This paper statement alone did not control the 109 directions; item 12 records the later source-coupling result. | [`JCG-24F172FB`](../../claims/JCG-24F172FB.md) · [proof](../../assets/manuscripts/{{MANUSCRIPT_05}}#page=19) |
...
| 14 | In the pinned 115-dimensional equivariant operation slice, the row-zero tangent has dimension 20, the rank-six tangent has dimension 22 and contains it, and \(\Lambda_4(\mathcal O_4(P))=1\) on the full affine 22-plane. | [RMU-5A110520](../working-mathematics/units/RMU-5A110520.md) · exact PR-head replay |
| 15 | One two-dimensional tangent section projecting to the two extra rank-six directions has an exact lift through second order. The full 66-parameter quadratic tangent search then gives cubic effect rank 15 and augmented rank 16, with an exact left-null witness of pairing \(-256/3\); this selected plane does not lift through cubic order. | [RMU-5A110521](../working-mathematics/units/RMU-5A110521.md) · [RMU-5A110523](../working-mathematics/units/RMU-5A110523.md) |
...
The new 22-dimensional equivariant tangent bridge closes one tempting local
enlargement because its quartic value is identically \(1\). Its selected
second-order rank-six section is also intrinsically obstructed at cubic order
after all 66 quadratic tangent parameters are included. This strengthens the
local exclusion but does not alter the moving-target/stable-gauge frontier.
...
- **Generalize the selected-plane cubic obstruction.** The exact 66-parameter
  search closes the quadratic freedom only for one explicit first-order plane
  in the 115-dimensional source-field model. It does not treat other planes
  or the full source/target/stable quotient.
