...
**July 30 import checkpoint.** The newer eleven-conversation intake adds 29
scoped records spanning six paper audits, degrees five/six, Program 5
coupling, and Program 9. Its self-contained checks replay; Program 5 v3 lacks
inputs. Public draft PR 1 recovers the Program 9 package and larger Program 6
packet (38 tests pass), but not the complete-chain subgroup. No paper or
global theorem is promoted. Next perform atomic
occurrence, equivalence, primary-home, and reverse-map reconciliation.
