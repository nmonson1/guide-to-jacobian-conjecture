...
was recovered here; treat the formalism as a design specification, not a
...
The later filtered-action package reported in conversation is a separate
unrecovered implementation. Its claimed tests and Program 5/6 adapters were
not run locally and supply no additional replay receipt.
