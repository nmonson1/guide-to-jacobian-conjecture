...
- `strengthens` [`JCG-978BC8D0`](../units/JCG-978BC8D0.md): The earlier retained slice has dimension 20; this computation places it inside the full 22-dimensional rank-six tangent and evaluates the quartic functional on all 22 directions.
- `related_to` [`JCG-F245F636`](../units/JCG-F245F636.md): This is an independently exported equivariant tangent calculation for the same Program 5 compression problem, not a replacement for the larger 726-dimensional operation audit.
