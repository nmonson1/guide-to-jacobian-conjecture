...
### [Complete PRS graph and chartwise toroidal inverse graph](../units/RMU-4D2E0002.md)
...
### [Convention-complete adjacent monomial merge theorem](../units/RMU-4E2F0002.md)
...
### [Convention-complete all-rank PRS and Hankel block theorem](../units/RMU-4D2E0010.md)
...
### [Global normalization of the fixed quintic outer multi-Rees graph](../units/RMU-4E2F0001.md)

`RMU-4E2F0001` · `theorem`
...
- **proof:** Global bihomogeneous presentation, chartwise normalization and gluing proof, with two exact replay programs. — `research-notes/lane2-projective-normalization-20260803-v1/bihomogeneous-normalization.md`
  - Does not establish: All-rank PRS compatibility or a general Torelli theorem.
...
- `uses` [`RMU-F7236EAC`](../units/RMU-F7236EAC.md): Formal statement references thm:all-multiplicity-torelli.
- `uses` [`RMU-29697C11`](../units/RMU-29697C11.md): Formal statement references prop:one-root-transition.
