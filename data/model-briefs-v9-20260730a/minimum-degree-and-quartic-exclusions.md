...
**Research state:** mathematical checkpoint 30 July 2026, including the
recovered and replayed nonresonant `F_3/F_4` degree-three archive and the
conditional high-ramification and fixed-component closures, plus the
companion/Jordan-chain budget as an audit lens.
...
alone; the linked [working paper](../../assets/manuscripts/{{MANUSCRIPT_02}}),
...
└─ rho_4 = 2 ── four-locus reduction
   ...
   │  ├─ degree 3 ── displayed nonresonant F_3/F_4 excluded;
   │  │              branch exhaustiveness + resonant charts open
...
| 4 | Assuming the preceding leading-curve reduction and the rank-one, conic, rational-cubic, balanced-quartic, and tricuspidal-quartic exclusions, every nonautomorphic quartic Keller map has leading target span exactly two. The assumptions are part of the statement. | [`JCG-90614345`](../../claims/JCG-90614345.md), [`JCG-F13D186D`](../../claims/JCG-F13D186D.md) · [proof of both final rational-quartic strata and synthesis](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=16) |
| 5 | In the quadratic-source `(e,d)=(2,2)` branch, the genuinely nonbinary **no-fixed-component** locus is impossible in all nine normalized charts. Fixed-component chart boundaries exit to item 7 or the fixed-component results in items 13–17. | [`JCG-B2D60A95`](../../claims/JCG-B2D60A95.md) · [proof with all nine charts](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=18) |
| 6 | Assume the Program 2 structural reductions and a coprime binary pencil `H_4=(P,Q,0)`. If `Delta=gcd(J(Q,R),J(P,R),J(P,Q))` has degree at most two, then `F` is an automorphism. Regular, simple-root, double-root, and squarefree-double branches are separate mechanisms. | [`JCG-1AE58E51`](../../claims/JCG-1AE58E51.md), [`JCG-176D3DFE`](../../claims/JCG-176D3DFE.md), [`JCG-059D835C`](../../claims/JCG-059D835C.md) · [proof through double ramification](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=18) |
| 7 | In the special chart `H_4=(0,0,x^2y^2)` with cubic pencil `<x^2y,xy^2>`, the Keller equations force the third column of `L` to vanish. This is one rank-one/fixed-component boundary calculation, **not** a target-span-two classification. | [`JCG-34460CE2`](../../claims/JCG-34460CE2.md) · [complete Plücker-chart proof](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=17) |
| 8 | The paper records a degree-three ramification route from the `(2,5)` and generic `(3,4)` types to automorphic, cube, fourth-power, fixed-component, source-shear, `F_3`, and `F_4` exits. The recovered archive exactly verifies the displayed `F_3/F_4` formulas and their nonresonant `D_5` exclusions with arbitrary lower binary terms, but the original elimination proving that `F_3/F_4` exhaust the weighted-inflection branch was not recovered. Treat the routing exhaustiveness as open. | [`JCG-9D9C3DF9`](../../claims/JCG-9D9C3DF9.md) · [paper routing and exceptional queue](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=20) |
| 9 | On the reconstructed generic `(3,4)` open chart, after inverting the displayed denominator, rank-minor, resonance, and weighted-inflection factors, the `6 x 8` next-layer matrix has rank six and the two displayed kernel vectors span its kernel; over the algebraic closure their plane meets the quadratic Veronese only at the origin. Nothing is asserted on the inverted divisors. | [`JCG-9D9C3DF9`](../../claims/JCG-9D9C3DF9.md) · [exact generic calculation and nonvanishing factors](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=20) |
| 10 | Subject to items 3–6 and membership in the primitive coprime binary-pencil locus, common ramification degree `r=4` or `r=5` forces an automorphism. The `r=4` proof covers dependent residuals, the square and reduced residual quadratics, the complete repeated-root incidence, the omitted projective point, and the `2+2` kernel. | [`JCG-5C216C29`](../../claims/JCG-5C216C29.md) · [theorem and proof](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=21) |
| 11 | Subject to the primitive span-two reduction, a fourth-power pencil member adds no leaf: its highest nonzero normal layer routes to an aligned, binary, or quadratic-source branch. | [`JCG-5EF7883D`](../../claims/JCG-5EF7883D.md) · [proposition and proof](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=22) |
| 12 | In the binary branch, if one of `U=J(Q,R)`, `V=J(P,R)`, or `W=J(P,Q)` vanishes—including the separate `R=0` case—the map is automorphic. Apply the ordinary ramification-degree filtration only after removing these boundaries. | [`JCG-5E7E9377`](../../claims/JCG-5E7E9377.md) · [proposition and proof](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=22) |
| 13 | In the primitive fixed-component branch `P=GA,Q=GB`, if `Gamma` has multiplicity `s` in `G` and `m` in the reduced fiber over `xi`, then `4 nu_Gamma(R)=3s+c_xi m` and `sum c_xi=3`, with the adjusted infinity convention. The `c_xi` can be negative. This supersedes the formula without `3s` and every proof assuming all `c_xi>=0`. | [`JCG-39A7571B`](../../claims/JCG-39A7571B.md) · [corrected lemma and proof](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=23) |
| 14 | Subject to the four-loci reduction and the standard two-variable polynomial-centralizer theorem, every genuinely nonbinary primitive fixed-component branch is closed. | [`JCG-48D499D2`](../../claims/JCG-48D499D2.md) · [valuation and residual-pole proof](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=23) |
| 15 | Subject to the binary fixed-component reduction, every cubic fixed factor is automorphic or undergoes a triangular degree drop; squarefree, double-plus-simple, and triple-line multiplicities are covered. | [`JCG-DAFBEDD5`](../../claims/JCG-DAFBEDD5.md) · [computer-assisted theorem](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=24) |
| 16 | Subject to the binary fixed-component reduction, every linear fixed factor is automorphic. After `H_4=(x^4,xB,0)`, both residual-cubic orbits and every exceptional divisor are covered. | [`JCG-4077AC78`](../../claims/JCG-4077AC78.md) · [computer-assisted theorem](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=24) |
| 17 | Subject to the binary fixed-component reduction, every quadratic fixed factor with coprime residual quadrics is automorphic. Normalize `P=x^2G,Q=y^2G`; the discriminant, two axis-tangencies, resultant, all intersections, and projective endpoints are covered by 38 exact replay groups. | [`JCG-3C448C71`](../../claims/JCG-3C448C71.md) · [determinant and exceptional sweep](../../assets/manuscripts/{{MANUSCRIPT_02}}#page=24) |
| 18 | In dimension three, for every ordinary degree `d`, a Keller map cannot have a **period-primitive** leading line. “Period-primitive” is distinct from composition-primitive and coprime. | [stable register statement and derivation](../../assets/manuscripts/{{MANUSCRIPT_07}}#page=9) |
...
| 8, triple ramification | The recovered exact archive verifies the displayed `F_3/F_4` component formulas, the full generic determinant identities with arbitrary lower binary terms, and the nonresonant `D_5` exclusions. **Output:** exact nonresonant certificates for the two displayed families. | The lost component-exhaustiveness elimination, `tau=0,-1`, `tau^2+1=0`, the full `c=0` chart, and dependent-`a,b` syzygies remain; “triple ramification closed” would be false. |
...
**(F1) Degree-three branch classification and resonant completion**
*(nonresonant `F_3/F_4` compatibility replayed; exhaustive routing still
open).*

From the full determinant with arbitrary lower binary terms and linear part,
the recovered archive verifies the universal top-`D_6` and `[z^2]D_5`
identities. The displayed nonresonant `F_3` family has coefficient gcd one.
For `F_4`, all six top-`D_6` equations hold modulo the exact quadratic
`q4(d,tau)`, while four lower-term-independent `D_5` resultants have primitive
gcd one. A clean SymPy 1.14.0 replay reproduced all thirteen outputs
byte-for-byte. This excludes both displayed nonresonant families.

The archive supplies and verifies the `F_3/F_4` parametrizations; it does not
reconstruct the elimination proving they exhaust the weighted-inflection
locus. It leaves `tau=0,-1`, the common-root divisor `tau^2+1=0`, most of the
`c=0` chart, and dependent-`a,b` syzygies open. The regular marked chart is a
useful coordinate comparison, but shares the same symbolic lineage and does
not prove historical-chart identification.

Five conjunctive gates remain before a complete degree-three theorem:

1. derive the `F_3/F_4` components from the common-root kernel plane and prove
   their exhaustiveness after imposing the quadratic Veronese relations;
2. close `tau=-1`, `tau=0`, and the `tau^2+1` chart divisor without
   specializing a denominator through zero;
3. complete the lower `D_6`-to-`D_5` calculation on the `c=0` minimal-syzygy
   chart;
4. classify every dependent-`a,b` chart, distinguishing genuine normals from
   integrable source shears; and
5. audit upstream branch placement and the global quartic case tree with an
   independent proof/code comparison.

The historical marked-chart consistency anchors remain useful cross-checks:
...
The dependency picture is therefore short: derive the `F_3/F_4` branch list
rather than importing it; close the resonant, `c=0`, and dependent-syzygy
charts; assign every exceptional divisor to a proved exit; and certify that
the span-two reduction really reaches the stated pencil/fixed-component
leaves. Exact programs verify the identities and chart ideals they encode,
but do not themselves prove proof-to-code correspondence or global
exhaustiveness. Do not describe “triple ramification” as closed until that
...
In the quartic span-two setup these imply `H >= 4`. The
controlling v4 calculations route the `H=5,6` linear-kernel leaves into known
loci and exclude the displayed minimal fourth-power, simple fixed-line, and
smooth-conic `H=4` charts, conditional on their normal forms and case
placement.

Use this in P2-T2/T3 as a consistency check. It
does not replace the stronger July 29 closures, derive the `F_3/F_4` branch
list, close resonant degree-three charts, or prove `D_min >= 5`. The
construction is presentation-sensitive, not invariant under arbitrary
polynomial left-right equivalence, and therefore is not Lane 5's intrinsic
orbit-degree budget. Its exact programs do not independently prove the
sheaf-theoretic kernel flag and endpoint identifications.
...
**P2-T1 — Complete the degree-three branch classification and resonant
charts.** Actor: `online_model` for geometric classification plus
`local_symbolic` for exact eliminations. Status: ready.
*Payoff:* converts the replayed nonresonant `F_3/F_4` calculations into a
complete degree-three theorem; if T2 finds no routing gap, closes the remaining
mathematical leaf in degree four.
*Attack:* finish the kernel-plane intersection with the quadratic Veronese
relations over `Q(tau,w)`, saturating by every named chart divisor. Then treat
`tau=-1`, `tau=0`, `tau^2+1=0`, `c=0`, and the dependent-syzygy charts
separately. Use the marked-chart calculation and the `104/3` anchors as
coordinate cross-checks, not substitutes for branch exhaustiveness.
*Done when:* all five gates in F1 are closed by exact branch equations,
divisor ownership, case-tree locators, and an independent implementation.
...
The [Program 2 working paper](../../assets/manuscripts/{{MANUSCRIPT_02}})
...
The recovered degree-three archive adds the displayed `F_3/F_4`
...
byte-for-byte. Branch discovery remains incomplete at `tau=0,-1`,
`tau^2+1=0`, `c=0`, dependent syzygies, and the global case tree.
...
- Do not ask a model to re-derive the nonresonant `F_3/F_4` incompatibility;
  use it as an exact input unless the assignment is a fresh reproduction.
