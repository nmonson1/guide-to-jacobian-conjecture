...
the local ring \(A\).
  ...
  - Full source and surrounding context: [`manuscripts/01-cubic-incidence/appendices/cubic-resolvent-defects.tex#prop:resolvent-mcm-criterion`](../../proof-sources/01-cubic-incidence/appendices/cubic-resolvent-defects.md#label-prop-resolvent-mcm-criterion)
