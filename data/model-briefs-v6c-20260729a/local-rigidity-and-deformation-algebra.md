...
This is the complete public handoff. The [working paper](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf),
...
| --- | --- | --- |
| 1 | Every unrestricted formal Keller deformation of the fixed étale map `G` is formally right-trivial: `H=G∘phi` with `det Dphi=1`. The formal `phi` may have unbounded degree, so this says nothing by itself about the degree-seven slice. | [`JCG-30FC31CC`](../../claims/JCG-30FC31CC.md) · [proof](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=4) |
| 2 | In the specified eleven-condition transverse slice inside `K_{3,7}`, the exact positive-, negative-, and zero-weight calculations make the local ideal `m`-primary; the torus-nullcone lemma therefore makes the reduced formal and analytic germ a point. | [`JCG-7A91920F`](../../claims/JCG-7A91920F.md) · [proof](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=7) |
| 3 | For that same completed transverse local algebra, `length R=584`, the Hilbert function is `(1,10,44,108,157,145,86,30,3)`, and the Loewy length is nine. This is intersection multiplicity, not a count of maps. | [`JCG-DD13AC0E`](../../claims/JCG-DD13AC0E.md) · [proof](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=9) |
| 4 | The exact rational border presentation for `R` has 584 standard monomials, 2,654 border relations, and ten commuting multiplication matrices with 24,402 nonzero entries. | [`JCG-F4C59FA0`](../../claims/JCG-F4C59FA0.md) · [proof and construction](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=19) |
| 5 | The Macaulay inverse system has 60 minimal contraction generators; hence `R` has type 60 and is neither Gorenstein, level, nor a complete intersection. | [`JCG-6FA7D42B`](../../claims/JCG-6FA7D42B.md) · [proof](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=10) |
| 6 | The minimal Kuranishi ideal of this slice has 36 generators: 11 quadratic, 13 cubic, 11 quartic, and one sextic. | [`JCG-525A42DB`](../../claims/JCG-525A42DB.md) · [proof](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=12) |
| 7 | The separately constructed marked-root source-flow and direct determinant complexes give the same filtered transverse Kuranishi ideal through parameter order four over `Q`, including the Hilbert prefix and generator counts. No all-order equivalence is asserted. | [`JCG-E4FFD82B`](../../claims/JCG-E4FFD82B.md) · [proof](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=16) |
| 8 | The second direct rational calculation gives `H(5)=145`, `H(6)=86`, and order-seven contribution 30; at order six it isolates exactly one new weight-three sextic class. Orders seven and eight are not reconstructed by this row. | [`JCG-D1903700`](../../claims/JCG-D1903700.md), [`JCG-525A42DB`](../../claims/JCG-525A42DB.md) · [proof and exact rank blocks](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=17) |
| 9 | In degree eight the determinant tangent kernel has dimension 44, hence 33 directions remain after the affine orbit; these include three source quadratic-shear and two target-shear families. | [`JCG-891B0275`](../../claims/JCG-891B0275.md) · [proof](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=18) |
| 10 | In the stated residual degree-eight slice, weight `-2` is eliminated over `Q`; weight `-1` survives through fourth order. Later death is modular evidence only and is not a characteristic-zero saturation theorem. | [`JCG-D3F76EBC`](../../claims/JCG-D3F76EBC.md) · [exact proved part and explicit boundary](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v12.pdf#page=19) |
