...
│  ├─ codimension one ── U1 / U2 / B (complete)
...
| 5 | For the finite normalization attached to a generic-degree-three complex Keller map, every target prime divisor has retained-sheet type `U1`, `U2`, or `B`; a deleted three-cycle is impossible. This is divisorial only. | [`JCG-1D7EF048`](../../claims/JCG-1D7EF048.md) · [proof](../../assets/manuscripts/{{MANUSCRIPT_01}}#page=19) |
...
| 8 | In the stated smooth cubic-axis hypersurface model, if the transverse three-torsion section extends through the smooth relative torsion group, the eigensheaf is MCM and the cubic normalization is flat. Both hypotheses are essential. | [`JCG-69028659`](../../claims/JCG-69028659.md) · [proof](../../assets/manuscripts/{{MANUSCRIPT_01}}#page=20) |
