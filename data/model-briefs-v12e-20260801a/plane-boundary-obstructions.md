...
**Paper-audit checkpoint, 30 July 2026.** The repair packet adds the missing
residue/order assumptions to Proposition 5.2 while retaining `e=17`, fixes
Proposition 3.3's codomain, supplies a hand proof for `A_21`, replaces C.8's
finite-etale step by finite plus Nakayama, and clarifies what the 7,121-row
Macaulay certificate proves. The independent symbolic, quintic-arithmetic,
and Hurwitz scripts replay. None closes queue exhaustiveness or attachment,
so the below-125 statement remains conditional. The public corrigendum and
three small-check programs are recovered on
[draft PR 4](https://github.com/nmonson1/guide-to-jacobian-conjecture/pull/4)
at `0b378effc3ac06f8aa07c77aaf05a827cc803d9f`; the branch is
unmerged and does not contain the large terminal replays.
