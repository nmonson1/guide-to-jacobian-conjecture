...
two-dimensional transverse section lifts through second order. Its chosen
fixed-minor continuation fails at order three, but unused order-two
tangent-kernel freedom makes that failure nonintrinsic. This
115-dimensional equivariant calculation is an independent sanity check, not
the larger 726/109/75 operation audit.
...
| 15 | One two-dimensional tangent section projecting to the two extra rank-six directions has an exact lift through second order. The fixed-minor continuation's order-three residual has rank four, but this is not intrinsic because order-two tangent-kernel freedom was fixed to zero. | [RMU-5A110521](../working-mathematics/units/RMU-5A110521.md) · [RMU-5A110522](../working-mathematics/units/RMU-5A110522.md) |
...
enlargement because its quartic value is identically \(1\). Its
second-order rank-six section and nonintrinsic order-three failure do not
alter the moving-target/stable-gauge frontier.
...
- **The fixed-minor order-three residual is an intrinsic obstruction.** It
  freezes the order-two tangent-kernel freedom; alternative corrections
  remain untested.
