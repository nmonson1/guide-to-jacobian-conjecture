...
alone. The linked [working paper](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf),
...
| --- | --- | --- |
| 1 | For a polynomial potential `H(T,c)` over a characteristic-zero field, the displayed root-slope substitution has Jacobian `-2` whenever its pole-cancellation conditions make it polynomial; its generic degree equals the root degree of `H`. | [`JCG-0106262F`](../../claims/JCG-0106262F.md) · [proof](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf#page=15) |
| 2 | For normalized cubic frames, polynomial left-right equivalence is exactly affine change of `c`, the prescribed scalar relation on `A`, congruence of `B` modulo `A`, and preservation of the marked root. Repeated roots are allowed. | [`JCG-221985FF`](../../claims/JCG-221985FF.md) · [proof](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf#page=7) |
| 3 | In the two-block multiplication-incidence construction with `a,b >= 1` and `a+b >= 3`, stable affineness occurs exactly for the unordered pair `{a,b}={1,2}`. | [`JCG-517DA8F4`](../../claims/JCG-517DA8F4.md) · [proof](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf#page=11) |
| 4 | For a coprime normalized cubic frame, the inverse cubic is irreducible with nonsquare discriminant, so generic monodromy is `S_3`; the target deck group is trivial. | [`JCG-504733CF`](../../claims/JCG-504733CF.md), [`JCG-5B09E55B`](../../claims/JCG-5B09E55B.md) · [proof](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf#page=5) |
| 5 | For the finite normalization attached to a generic-degree-three complex Keller map, every target prime divisor has retained-sheet type `U1`, `U2`, or `B`; a deleted three-cycle is impossible. This is divisorial only. | [`JCG-1D7EF048`](../../claims/JCG-1D7EF048.md) · [proof](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf#page=19) |
| 6 | The finite cubic normalization splits as `O ⊕ E` with `E` rank-two reflexive, and its nonflat locus is finite and contained in omitted values. Reflexivity alone does not imply flatness. | [`JCG-C04524CF`](../../claims/JCG-C04524CF.md), [`JCG-A5938472`](../../claims/JCG-A5938472.md) · [proof and defect boundary](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf#page=13) |
| 7 | If a cubic defect is encoded by the quadratic-resolvent eigensheaf, it cannot be supported only at an isolated resolvent singularity; nontrivial three-torsion is detected at height-two singular primes. | [`JCG-79BDB7F6`](../../claims/JCG-79BDB7F6.md) · [proof](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf#page=19) |
| 8 | In the stated smooth cubic-axis hypersurface model, if the transverse three-torsion section extends through the smooth relative torsion group, the eigensheaf is MCM and the cubic normalization is flat. Both hypotheses are essential. | [`JCG-69028659`](../../claims/JCG-69028659.md) · [proof](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf#page=20) |
...
*Inputs:* this page; the [Program 1 paper](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-29-v12.pdf), especially the cubic-resolvent defect appendix; the precise claims in F1–F2.
