...
- `corrects` `JCG-69028659`: The former smooth cubic-axis implication is unproved; the current appendix replaces it with the exact conditional comparison criterion.
