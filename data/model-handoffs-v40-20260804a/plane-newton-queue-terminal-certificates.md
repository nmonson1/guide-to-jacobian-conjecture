...
---
[Portfolio](state-of-the-program.md) · [Exact source packet](lane-8-source-packet.md) · [Optional runnable source ZIP](../inputs/lane-8-source-files.zip) · [Raw-support reconstruction input](lane-8-reconstruction-input.md) · [Release metadata](release.json) · [Retained mathematics](../working-mathematics/index.md) · [Current proof sources](../proof-sources/index.md)
