...
---
[Portfolio](state-of-the-program.md) · [Exact source packet](lane-1-source-packet.md) · [Optional runnable source ZIP](../inputs/lane-1-source-files.zip) · [Release metadata](release.json) · [Retained mathematics](../working-mathematics/index.md) · [Current proof sources](../proof-sources/index.md)
