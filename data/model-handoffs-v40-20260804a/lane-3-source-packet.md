...
- [`manuscripts/03-local-rigidity/appendices/border-basis-and-betti.tex`](#source-1139103a19ca0701) — `ef89b9aa858df05045d75a79314add26b9443ff8cbd38ecf3ea029a9d38d7cac`
- [`manuscripts/03-local-rigidity/code/rational-betti/README.md`](#source-9bf807df6c4005d1) — `39a6c3b29558215cc19605a94c999da36e90306a9a2af87ed32cd678e8ed691d`
- [`manuscripts/03-local-rigidity/code/rational-betti/aggregate_rational_beta2.py`](#source-67bcc2109c99adcd) — `a0b24232f516997e6414c5a77f14828f9f5f3ec246b7b3a862ea3d60c807f6aa`
- [`manuscripts/03-local-rigidity/code/rational-betti/build_rational_betti_queue.py`](#source-6fd3e76417213008) — `6e6f724e814fa9d89027075152f18970bde68ded161e2aca49086e06d111d987`
- [`manuscripts/03-local-rigidity/code/rational-betti/export_exact_koszul_multiplier.py`](#source-3e8a360d72585441) — `f176d193a71dd41b2e998b6e54ba2f43d4f4d38538bb9a6e95b41c9ab7475f6f`
- [`manuscripts/03-local-rigidity/code/rational-betti/koszul_rank_q.cpp`](#source-ee80ccde287b2cc7) — `adefa73b27cc88b1e35a3560c1c2e925c5836f386dfb64bd53fde9b85a3c0379`
- [`manuscripts/03-local-rigidity/code/rational-betti/program3_rational_betti.slurm`](#source-204b8229e0ddf8af) — `a89570db12e7b48d29da1de73783a0d57df7ae40a577d8c82e6e06c4306818ed`
- [`manuscripts/03-local-rigidity/code/rational-betti/run_rational_betti_block.sh`](#source-464b94476ce549e0) — `f7390ca532ec527c2daaa2ab4d95a68a44128a9ae991ee1b3b793d876758fad1`
...
- [`research-notes/program3-rational-beta2-audit-20260803-v1/README.md`](#source-8a20e73c5c1d9046) — `7aaf2c2ab2aadfefec26b64a5e36e2f95b8f699d5c0b53ae69a8968425a807c7`
- [`research-notes/program3-rational-beta2-audit-20260803-v1/replay_beta2_audit.py`](#source-2c04e986e39924e8) — `fa6dcf5d3f1892d5627df40c742a9c2785c9897ca6db353d638f4b28d9745d68`
- [`research-notes/program3-rational-beta2-audit-20260803-v1/verify_beta2_audit.py`](#source-91df3747a85774a3) — `cbc808bd9e57af7a77ce711d2112a6ba3a9815c6fd1cca9d1a21f844f561d867`

<a id="source-1139103a19ca0701"></a>
...
\begin{theorem}&#91;Exact rational second Betti number&#93;
\label{thm:rational-beta-two}
Over \(\mathbb Q\), the second Betti number of the transverse local algebra is
\&#91;
\boxed{\beta_2=354}.
\&#93;
\end{theorem}
...
\begin{proof}
The exact rational multiplier gives the torus-weight blocks of the Koszul
differentials \(d_2\) and \(d_3\). Direct row reduction over \(\mathbb Q\)
computes the ranks of all \(49\) nonzero or boundary blocks represented in
these two differentials. For each weight \(w\), the calculation evaluates
\&#91;
\dim_{\mathbb Q}(K_2)_w
-\operatorname{rank}_{\mathbb Q}(d_2)_w
-\operatorname{rank}_{\mathbb Q}(d_3)_w.
\&#93;
Summing the nonzero weight contributions gives \(354\). The versioned audit
receipt
\texttt{program3-rational-betti-q-beta2-audit-v1-20260803a}
pins the queue, every exact rank output, the upstream exact multiplier and
rank executable, the aggregation sources, and the replayed result by
SHA-256. Thus this equality uses exact rational arithmetic, not
finite-field extrapolation.
\end{proof}
...
\&#91;
\beta_0=1,\qquad\beta_1=36,\qquad\beta_2=354,\qquad
\beta_{10}=60
\&#93;
are exact, while upper semicontinuity gives the displayed finite-field
values as termwise upper bounds for \(\beta_3,\ldots,\beta_9\). The
...
\(\beta_3,\ldots,\beta_9\) remain an open computation.
\end{remark}

\begin{question}&#91;Rational Betti certification&#93;
\label{q:rational-betti}
Produce exact rational rank or homology certificates for
\(\beta_3,\ldots,\beta_9\). The border presentation reduces this to a finite
weight-by-weight calculation independent of the original Kuranishi
elimination.
\end{question}
</code></pre>

<a id="source-9bf807df6c4005d1"></a>

## `manuscripts/03-local-rigidity/code/rational-betti/README.md`
...
<a id="source-67bcc2109c99adcd"></a>

## `manuscripts/03-local-rigidity/code/rational-betti/aggregate_rational_beta2.py`
...
<a id="source-6fd3e76417213008"></a>

## `manuscripts/03-local-rigidity/code/rational-betti/build_rational_betti_queue.py`
...
<a id="source-3e8a360d72585441"></a>

## `manuscripts/03-local-rigidity/code/rational-betti/export_exact_koszul_multiplier.py`
...
<a id="source-ee80ccde287b2cc7"></a>
...
if &#91;&#91; "$#" -ne 5 &#93;&#93;; then
  echo "usage: sbatch --array=... $0 runner exact-rank-executable multiplier.bin queue.tsv OUTPUT_ROOT" &gt;&amp;2
  exit 2
fi
if &#91;&#91; -z "${SLURM_ARRAY_TASK_ID:-}" &#93;&#93;; then
  echo "this script must be submitted as a Slurm array" &gt;&amp;2
  exit 2
fi

srun "$1" "$2" "$3" "$4" "$SLURM_ARRAY_TASK_ID" "$5"
</code></pre>

<a id="source-464b94476ce549e0"></a>
...
<a id="source-8a20e73c5c1d9046"></a>

## `research-notes/program3-rational-beta2-audit-20260803-v1/README.md`
...
<a id="source-2c04e986e39924e8"></a>
...
<a id="source-91df3747a85774a3"></a>

## `research-notes/program3-rational-beta2-audit-20260803-v1/verify_beta2_audit.py`
