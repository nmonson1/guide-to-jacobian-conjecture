...
---
[Portfolio](state-of-the-program.md) · [Exact source packet](lane-4-source-packet.md) · [Optional runnable source ZIP](../inputs/lane-4-source-files.zip) · [Release metadata](release.json) · [Retained mathematics](../working-mathematics/index.md) · [Current proof sources](../proof-sources/index.md)
