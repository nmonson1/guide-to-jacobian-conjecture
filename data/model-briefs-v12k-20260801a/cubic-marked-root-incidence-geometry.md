...
alone. The linked [working paper](../../assets/manuscripts/{{MANUSCRIPT_01}}),
...
| 5 | For the finite normalization attached to a generic-degree-three complex Keller map, the corrected divisorial taxonomy is `U0`, `U1`, `U2`, or `B`; a deleted three-cycle is impossible. The linked v12 PDF still omits `U0`; the July 31 working source and audit packet contain the corrected formulation. This is divisorial only. | [`JCG-1D7EF048`](../../claims/JCG-1D7EF048.md) · [stale public statement](../../assets/manuscripts/{{MANUSCRIPT_01}}#page=19) |
...
| 7 | If a cubic defect is encoded by the quadratic-resolvent eigensheaf, it cannot be supported only at an isolated resolvent singularity; nontrivial three-torsion is detected at height-two singular primes. | [`JCG-79BDB7F6`](../../claims/JCG-79BDB7F6.md) · [proof](../../assets/manuscripts/{{MANUSCRIPT_01}}#page=19) |
| 8 | If one constructs a rank-one reflexive three-torsion module `M` on the quadratic resolvent, proves it is MCM, and matches its class with the normalization eigensheaf at every height-two singular prime, then codimension-two detection identifies the two modules and the cubic normalization is flat. A smooth cubic-axis picture does not by itself establish these hypotheses. | [`JCG-69028659`](../../claims/JCG-69028659.md) · [stale public formulation](../../assets/manuscripts/{{MANUSCRIPT_01}}#page=20) |
...
comparison criterion. The public v12 PDF remains stale until rebuilt, and
...
*Inputs:* this page; the [Program 1 paper](../../assets/manuscripts/{{MANUSCRIPT_01}}), especially the cubic-resolvent defect appendix; the precise claims in F1–F2.
