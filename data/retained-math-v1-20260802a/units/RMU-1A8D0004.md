...
- `supersedes` `JCG-AB57A9B2`: Replaces the vague resolvent reformulation by an exact carrier and equivalence.
- `supersedes` `RMU-5D20CFBF`: Strengthens the former sufficient MCM criterion to an equivalence.
