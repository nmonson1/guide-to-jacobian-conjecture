---
title: "Text proof source — 06-plane-boundary/appendices/gauge-filtered-residues.tex"
description: "Sanitized current source with exact labels when present."
---

# Text proof source

`manuscripts/06-plane-boundary/appendices/gauge-filtered-residues.tex`
...
Published SHA-256: `1ad786256e96ac7e0b198f6de548afd9e5198f948f53b896fc5927ec8a22d9da` · 6,132 bytes

## Exact label anchors

<a id="label-app-gauge-filtered-residues"></a>
- `app:gauge-filtered-residues` — source line 2
<a id="label-prop-gauge-normal-form"></a>
- `prop:gauge-normal-form` — source line 23
<a id="label-prop-extended-complex"></a>
- `prop:extended-complex` — source line 60
<a id="label-thm-filtered-residue-adjoint"></a>
- `thm:filtered-residue-adjoint` — source line 107
<a id="label-cor-resonant-de-rham"></a>
- `cor:resonant-de-rham` — source line 164
