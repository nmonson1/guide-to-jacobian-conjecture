...
- `depends_on` `RMU-1A8D0001`: Uses the minimal local presentation of the canonical defect.
...
- `depends_on` `RMU-1A8D0001`: Identifies the same canonical defect on the quadratic resolvent.
- `depends_on` `RMU-C1DD871B`: The corrected divisorial inertia list makes T/Q unramified in codimension one.
