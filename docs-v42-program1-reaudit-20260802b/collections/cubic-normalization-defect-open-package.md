...
!!! warning "Superseded working statement"
    Use the [current corrected unit](../research/working-mathematics/units/RMU-34FBCB8D.md).
...
*Defining · Partial Result · Proof offered — review pending*
...
!!! warning "Superseded working statement"
    Use the [current corrected unit](../research/working-mathematics/units/RMU-13177F24.md).
...
!!! warning "Superseded working statement"
    Use the [current corrected unit](../research/working-mathematics/units/RMU-A4B084FF.md).
...
*Shared · Conditional Flatness Criterion · Proof offered — review pending*
