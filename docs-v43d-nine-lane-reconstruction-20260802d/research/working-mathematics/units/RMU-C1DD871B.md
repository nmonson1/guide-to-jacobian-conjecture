...
- `corrects` `JCG-1D7EF048`: The legacy trichotomy omitted the U0 case outside the nonproperness set; the corrected current proposition gives the exact four-type classification.
- `corrects` `JCG-89916A56`: The old open trichotomy question is closed by the corrected classification, with U0 outside and U1, U2, or B on divisors in the nonproperness set.
