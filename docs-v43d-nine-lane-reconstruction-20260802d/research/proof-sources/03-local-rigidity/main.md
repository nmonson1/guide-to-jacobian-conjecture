---
title: "Text proof source — 03-local-rigidity/main.tex"
description: "Sanitized current source with exact labels when present."
---

# Text proof source

`manuscripts/03-local-rigidity/main.tex`
...
Published SHA-256: `e7785ae773bcc3474d67aa2ebe30184856de42a8f0850d59e1d9bbe5345cfeed` · 33,549 bytes
...
- `eq:normalization` — source line 92
<a id="label-eq-rho"></a>
- `eq:rho` — source line 97
<a id="label-thm-main"></a>
- `thm:main` — source line 111
<a id="label-prop-formal-orbit"></a>
- `prop:formal-orbit` — source line 186
<a id="label-sec-slice"></a>
- `sec:slice` — source line 214
<a id="label-eq-torus"></a>
- `eq:torus` — source line 223
<a id="label-prop-stabilizer"></a>
- `prop:stabilizer` — source line 230
<a id="label-def-slice"></a>
- `def:slice` — source line 294
<a id="label-prop-transversality"></a>
- `prop:transversality` — source line 313
<a id="label-cor-local-product"></a>
- `cor:local-product` — source line 349
<a id="label-sec-kuranishi"></a>
- `sec:kuranishi` — source line 377
<a id="label-eq-kuranishi-ring"></a>
- `eq:kuranishi-ring` — source line 409
<a id="label-sec-reduced"></a>
- `sec:reduced` — source line 419
<a id="label-lem-nullcone"></a>
- `lem:nullcone` — source line 425
<a id="label-prop-pure-weight"></a>
- `prop:pure-weight` — source line 467
<a id="label-thm-reduced"></a>
- `thm:reduced` — source line 513
<a id="label-rem-scope"></a>
- `rem:scope` — source line 541
<a id="label-sec-length"></a>
- `sec:length` — source line 549
<a id="label-prop-terminal"></a>
- `prop:terminal` — source line 568
<a id="label-prop-order-nine"></a>
- `prop:order-nine` — source line 607
<a id="label-cor-hilbert"></a>
- `cor:hilbert` — source line 650
<a id="label-sec-inverse"></a>
- `sec:inverse` — source line 668
<a id="label-thm-inverse"></a>
- `thm:inverse` — source line 679
<a id="label-cor-socle"></a>
- `cor:socle` — source line 723
<a id="label-sec-equations"></a>
- `sec:equations` — source line 759
<a id="label-thm-equations"></a>
- `thm:equations` — source line 762
<a id="label-cor-betti"></a>
- `cor:betti` — source line 801
<a id="label-sec-computation"></a>
- `sec:computation` — source line 819
<a id="label-sec-interpretation"></a>
- `sec:interpretation` — source line 875
<a id="label-q-source-flow-verifier"></a>
- `q:source-flow-verifier` — source line 916
...
\appendix
\input{appendices/root-coordinate-source-flow}
\input{appendices/source-flow-reconstruction-progress}
