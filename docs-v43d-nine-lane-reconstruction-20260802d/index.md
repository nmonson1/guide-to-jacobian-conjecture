...
<div class="path-grid path-grid-four">
  ...
  <a class="path-card" href="research/">
    ...
    <p>Browse six working research programs, 85 result collections, 19 open-problem collections, 368 tagged claims, and seven dated manuscripts.</p>
    <span>Research →</span>
  </a>
</div>
...
**29 July 2026, Pacific time.** The selected release contains a sanitized 368-claim public graph, organizes it into 104 grouped packages and 534 memberships, and publishes version 13 of the six reader manuscripts and companion register. Eight new packages cover cubic resolvent defects,
