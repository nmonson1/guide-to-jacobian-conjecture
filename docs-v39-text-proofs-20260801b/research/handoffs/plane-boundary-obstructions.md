...
<p class="handoff-snapshot"><strong>Snapshot:</strong> 1 August 2026 · 368 public claim records · 104 grouped packages · manuscripts v13 · handoff source v12m · site release <code>living-guide-public-v39-text-proofs</code>.</p>
...
!!! info "Retained working graph"
    ...
    in the [retained working mathematics view](../working-mathematics/programs/plane-boundary-obstructions.md).

!!! tip "Current text proofs — preferred"
    Use the [current TeX source and exact label anchors](../proof-sources/06-plane-boundary/main.md) for full proof context. PDFs are optional archival
