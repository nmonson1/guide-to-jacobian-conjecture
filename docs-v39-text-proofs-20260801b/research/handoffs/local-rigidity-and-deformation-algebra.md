...
!!! info "Retained working graph"
    ...
    in the [retained working mathematics view](../working-mathematics/programs/local-rigidity-and-deformation-algebra.md).

!!! tip "Current text proofs — preferred"
    Use the [current TeX source and exact label anchors](../proof-sources/03-local-rigidity/main.md) for full proof context. PDFs are optional archival
