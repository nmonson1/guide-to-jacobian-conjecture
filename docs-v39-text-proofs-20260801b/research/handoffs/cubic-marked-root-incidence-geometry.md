...
!!! info "Retained working graph"
    ...
    in the [retained working mathematics view](../working-mathematics/programs/cubic-marked-root-incidence-geometry.md).

!!! tip "Current text proofs — preferred"
    Use the [current TeX source and exact label anchors](../proof-sources/01-cubic-incidence/main.md) for full proof context. PDFs are optional archival
