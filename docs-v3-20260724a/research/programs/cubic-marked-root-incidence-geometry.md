...
The marked-root interpretation of the original map, its basic fiber geometry, and the static hyperplane-orbit picture are credited background.  The manuscript's new classification and rigidity statements are presented with their proofs.  The remaining nonsquarefree classification question is labeled as open.

## Working manuscript

[Download the versioned PDF](../../assets/manuscripts/01-cubic-marked-root-covers-2026-07-22-v2.pdf){ .md-button .md-button--primary }

Nathaniel Monson · manuscript dated 2026-07-22 · 27 pages · SHA-256 `c9270ea8c7698f39113b69aca4434112c3cc6a8fdbe02ad00075abc4c85ee6de`
