---
title: "The explicit constructions give the upper bound N_min <= 19 for cubic-homogeneous…"
...
<p class="claim-tag">JCG-0EDD5AE2</p>
# The explicit constructions give the upper bound N_min <= 19 for cubic-homogeneous…
...
- [Cubic Homogeneous Descendant Construction](../collections/cubic-homogeneous-descendant-construction.md) — defining, primary statement
...
- `supp-note-05-008` in `papers-release-2026-07-26-v8/05-homogeneous-descendants/appendices/additional-results-and-leads.tex` (version-8 supplementary statement with explicit evidence boundary)

## Current retained record

[Open the full mathematical unit](../research/working-mathematics/units/JCG-0EDD5AE2.md)
