...
[Open the current Cubic Marked-Root Incidence Geometry graph view](../working-mathematics/programs/cubic-marked-root-incidence-geometry.md)
...
- [Lane 1: cubic flatness normalization defects](cubic-flatness-normalization-defects.md)
