...
[Open the current Local Rigidity and Deformation Algebra graph view](../working-mathematics/programs/local-rigidity-and-deformation-algebra.md)
...
- [Lane 3: bounded degree deformation modulus onset](bounded-degree-deformation-modulus-onset.md)
