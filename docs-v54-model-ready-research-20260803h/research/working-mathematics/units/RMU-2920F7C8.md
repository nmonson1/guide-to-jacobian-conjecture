---
title: "Exact leading target span in degree four"
description: "Subject to the leading-image routing of \\cref{lem:leading-image} and\n\\cref{rem:leaf-accounting}, every nonautomorphic quartic Keller map has\nleading target span exactly two."
---

# Exact leading target span in degree four

`RMU-2920F7C8` · `corollary` · statement version `1`
...
- `uses` `RMU-5D51D3A5` (external graph reference) — Formal statement references lem:leading-image.
