---
title: "Five-variable universal order-six reduction"
...
`RMU-3D8E0002` · `computational_result` · statement version `1`
...
- The universal modular order-five and order-six systems at the selected first-normal direction.
...
### Corrected modular universal-system construction, coefficient-span reduction, and complete 325-column base comparison.

`SUP-RMU3D8E0002-01` · `program`

Corrected modular universal-system construction, coefficient-span reduction, and complete 325-column base comparison.

**Establishes:** The fixed-image containment and five-variable reduction over F_1000033.

Does not establish:

- Constant rank or a universal unit certificate.
- Characteristic-zero validity away from the two exact sample jets.

## Mathematical connections

- `related_to` [`RMU-3D8E0001`](RMU-3D8E0001.md) — The universal modular reduction extends the setup of the two exact characteristic-zero sample exclusions.
