...
`JCG-4D953715` · `assertion` · statement version `2`
...
`SUP-JCG4D953715-01` · `source_assertion`

theorem and proof

**Establishes:** The located source records this statement and its stated evidence boundary.

**Source:** [Open the published source](../../proof-sources/04-stable-moduli/appendices/categorical-boundary-quotient.md#label-thm-fppf-wall-nonalgebraic)
