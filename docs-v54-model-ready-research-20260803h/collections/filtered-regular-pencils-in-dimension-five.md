...
### [JCG-3FB0B6BB · An everywhere-regular five-dimensional quadratic nilpotent line pencil whose kernel map spans…](../claims/JCG-3FB0B6BB.md)

An everywhere-regular five-dimensional quadratic nilpotent line pencil whose kernel map spans P4 has saturated filtration degrees (-4,-2,0,2,4); every successive map is an isomorphism and the kernel map is the rational normal quartic.

*Defining · Primary Statement · Proof supplied*

### [JCG-C992885C · Every quadratic matrix annihilating the Veronese kernel k_m factors uniquely as N=L_mS_m;…](../claims/JCG-C992885C.md)
...
### [JCG-154408D7 · With the quartic kernel fixed at the principal point, the nilpotent-pencil tangent…](../claims/JCG-154408D7.md)
...
### [JCG-566A5F84 · For a general five-dimensional quadratic pencil, integrable markings lie on the proper…](../claims/JCG-566A5F84.md)
...
### [JCG-A82581C7 · For a global regular-type five-dimensional nilpotent quadratic tensor with full-span collisio…](../claims/JCG-A82581C7.md)
...
### [JCG-D49A43DC · In the five-dimensional square-zero two-matrix ansatz with a coordinate collision, exactly th…](../claims/JCG-D49A43DC.md)
...
### [JCG-15D52C7B · Any global homogeneous quadratic nilpotent 5 by 5 Jacobian extending an everywhere-regular…](../claims/JCG-15D52C7B.md)
