---
title: "All Generic Degrees Family"
...
The theorem-level package is centered on the following mechanism: For every integer d at least 3, there is a nonproper Keller map from complex affine 3-space to itself with generic degree d.  Its supporting records isolate the ingredients that establish the statement and the qualifications that control its scope.
...
The all-degree weighted-lift family has full \(S_n\) monodromy under a Morse condition on the seed polynomial.

*Defining · Supporting Result · recorded*

[Open the deeper technical record](../technical/technical-claim-7d6af6c6.md)
