---
title: "Face-to-passport formula"
description: "The rational function \\(\\tau\\) is a degree-\\(mnb\\) Belyi map and\n\\begin{equation}\n\n\\tau'(z)=z^{n-1}\\frac{p(z)^{n-1}}{q(z)^{m+1}}.\n\\end{equation}\nIts passport is\n\\begin{equation}\n\n\\left(n^{mb}\\right),\\qquad\n\\left(m^{nb}\\right),\\qquad\n\\left((m+n)b-1,1^{mnb-(m+n)b+1}\\right).\n\\end{equation}"
---

# Face-to-passport formula

`RMU-D544A37E` · `proposition` · statement version `1`
