---
title: "Let L/K(lambda) be the cubic radial extension at the exceptional marked-root end,…"
...
# Let L/K(lambda) be the cubic radial extension at the exceptional marked-root end,…

`JCG-4D6F79C6` · `assertion` · statement version `1`
