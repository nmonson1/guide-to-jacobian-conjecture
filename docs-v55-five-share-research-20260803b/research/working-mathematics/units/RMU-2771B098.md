---
title: "Genuinely nonbinary fixed components"
description: "Assume the four-loci reduction and the polynomial-centralizer fact stated\nat the beginning of this appendix.  Every genuinely nonbinary primitive\nfixed-component branch is closed."
---

# Genuinely nonbinary fixed components

`RMU-2771B098` · `theorem` · statement version `1`
