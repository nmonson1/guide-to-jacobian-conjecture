---
title: "The cubic incidence open is affine three-space"
description: "For every tangent but nonosculating hyperplane \\(H\\) in the case\n\\(\\{a,b\\}=\\{1,2\\}\\), one has\n\\[\nU_{a,b,H}\\simeq\\A^3.\n\\]\nThis supplies the positive direction of \\cref{thm:stable-uniqueness} without\nan appeal to an unspecified public construction."
---

# The cubic incidence open is affine three-space

`RMU-FA7978C0` · `proposition` · statement version `1`
...
- `uses` [`RMU-BA2C2F76`](RMU-BA2C2F76.md) — Formal statement references thm:stable-uniqueness.
