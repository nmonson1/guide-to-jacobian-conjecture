...
### [JCG-891B0275 · At degree eight, the determinant linearization has kernel dimension 44, hence 33…](../claims/JCG-891B0275.md)
...
### [JCG-0632B2B1 · On the five explicit degree-eight coordinate directions, the corrected quadratic/cubic equati…](../claims/JCG-0632B2B1.md)
...
### [JCG-ECF242AB · Degree-eight affine rigidity fails: composing G with z -> z+f(x,y) for quadratic…](../claims/JCG-ECF242AB.md)
...
### [JCG-D3F76EBC · For the degree-eight local Kuranishi problem, the residual 28-dimensional slice reduces to…](../claims/JCG-D3F76EBC.md)

For the degree-eight local Kuranishi problem, the residual 28-dimensional slice reduces to weights -2 and -1; weight -2 is eliminated over Q, while weight -1 survives to fourth order and has only modular death evidence at order six.

*Defining · Primary Statement · Evidence Only*

### [JCG-24C82405 · At the degree-eight base point, after quotienting the affine orbit and the…](../claims/JCG-24C82405.md)
