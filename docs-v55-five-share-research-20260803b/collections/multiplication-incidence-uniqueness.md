...
### [JCG-292A9B9D · For multiplication-incidence opens from P^a x P^b, the next (2,3) candidate fails…](../claims/JCG-292A9B9D.md)
...
### [JCG-DBB38171 · A rank-three affine-linear family whose full simple-root incidence is affine three-space lies…](../claims/JCG-DBB38171.md)
...
### [JCG-06EFD647 · An affine-root incidence component of degree at least two cannot be A2,…](../claims/JCG-06EFD647.md)
...
### [JCG-517DA8F4 · Within the binary two-block multiplication-incidence construction U_{a,b,H}, stable affinenes…](../claims/JCG-517DA8F4.md)

Within the binary two-block multiplication-incidence construction U_{a,b,H}, stable affineness, and hence affineness, occurs only for the unordered pair {a,b}={1,2}.

*Defining · Primary Statement · Proof supplied*

### [JCG-C5D74708 · In the binary-form multiplication model of the counterexample, the resultant-one double-root…](../claims/JCG-C5D74708.md)
