...
### [JCG-4EE846CD · Extend the finite-root all-multiplicity classification across strata where deleted roots esca…](../claims/JCG-4EE846CD.md)
...
### [JCG-2F2C2F29 · At ambient bound N, degree-preserving cubic-frame root translations are exactly the kernel…](../claims/JCG-2F2C2F29.md)
...
### [JCG-66049841 · For a kernel-of-an-endomorphism translation action over a Q-algebra, the invariant algebra is…](../claims/JCG-66049841.md)
...
### [JCG-4D953715 · Let R be a DVR with uniformizer pi and let e >=…](../claims/JCG-4D953715.md)
...
*Shared · Scope Restriction · Proof supplied*

### [JCG-62905FD2 · At a simple escape wall the graph closure is the blowup of…](../claims/JCG-62905FD2.md)
...
*Shared · Partial Construction · Proof supplied*
