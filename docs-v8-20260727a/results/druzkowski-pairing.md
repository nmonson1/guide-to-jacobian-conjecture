...
The theorem-level package is centered on the following mechanism: The explicit pairing dictionary gives a 110D Druzkowski construction, while the derivative-space zero-block and equality-case argument give the model-relative bound 52 <= pairing rank <= 110 for the fixed 19D tensor.  Its supporting records isolate the ingredients that establish the statement and the qualifications that control its scope.
...
### Explicit Counterexample: An explicit square-zero Druzkowski pairing of the 19D cubic gives a 135D Druzkowski counterex…
...
[Open the deeper technical record](../technical/explicit-counterexample-an-explicit-square-zero-druzkowski-pairing-of-the-19d-cubic-0378b011.md)

### Pairing Bounds: The explicit pairing dictionary gives a 110D Druzkowski construction, while the derivative-sp…

The explicit pairing dictionary gives a 110D Druzkowski construction, while the derivative-space zero-block and equality-case argument give the model-relative bound 52 <= pairing rank <= 110 for the fixed 19D tensor.

*Defining · Primary Statement · recorded*

[Open the deeper technical record](../technical/pairing-bounds-the-explicit-pairing-dictionary-gives-a-110d-druzkowski-construction-while-263402aa.md)

### Two Matrix Family: An exact row-defect theorem holds in the two-matrix square-zero family; the accompanying fini…
...
[Open the deeper technical record](../technical/two-matrix-family-an-exact-row-defect-theorem-holds-in-the-two-8f25fc7b.md)

### Square Zero Pairing Stable Equivalence: A full-rank square-zero Gorni-Zampieri pairing H=B(Dz)^{*3}, BD=0, is triangularly right-equi…
...
[Open the deeper technical record](../technical/square-zero-pairing-stable-equivalence-a-full-rank-square-zero-gorni-zampieri-99288d5e.md)
...
[Open the deeper technical record](../technical/open-question-what-is-the-exact-minimal-square-zero-druzkowski-pairing-rank-72a99572.md)
...
- [The Minimum Drużkowski Pairing Rank](minimum-druzkowski-pairing-rank.md)
