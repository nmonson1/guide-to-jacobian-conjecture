---
title: "The Minimum Dimension for a Cubic-Homogeneous Counterexample"
description: "What is the true smallest dimension of a cubic-homogeneous counterexample?"
---

# The Minimum Dimension for a Cubic-Homogeneous Counterexample

<p class="dek">What is the true smallest dimension of a cubic-homogeneous counterexample?</p>

<span class="status status-kind">Open problem</span> <span class="status status-draft">Working draft</span>

**Credited to Nathaniel Monson (research direction and mathematical responsibility); William Thompson (computation).**
...
The problem is organized around one precise obstruction: What is the true smallest dimension of a cubic-homogeneous counterexample?  The supporting records separate known constraints from the remaining global step.
...
[Open the deeper technical record](../technical/exclude-low-dimensional-sl-and-sp-prolongation-extensions-35542bb2.md)
