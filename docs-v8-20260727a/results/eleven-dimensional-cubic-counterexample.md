---
title: "The Explicit Eleven-Dimensional Cubic Counterexample"
...
# The Explicit Eleven-Dimensional Cubic Counterexample

<p class="dek">The cited map from complex affine 11-space to itself has total degree 3, 52 nonzero monomial terms, constant Jacobian determinant -2, and three displayed distinct rational inputs with one common image.</p>

<span class="status status-kind">Result</span> <span class="status status-draft">Established public record</span>

**Credited to Spacerat (computation).**
...
The theorem-level package is centered on the following mechanism: The cited map from complex affine 11-space to itself has total degree 3, 52 nonzero monomial terms, constant Jacobian determinant -2, and three displayed distinct rational inputs with one common image.  Its supporting records isolate the ingredients that establish the statement and the qualifications that control its scope.
...
**Evidence present:** exact certificate.
