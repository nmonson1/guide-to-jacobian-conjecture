...
The theorem-level package is centered on the following mechanism: The eta-family supplies stable moduli with boundary curves of arbitrary genus.  Its supporting records isolate the ingredients that establish the statement and the qualifications that control its scope.
