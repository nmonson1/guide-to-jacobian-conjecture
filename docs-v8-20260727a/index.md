...
<div class="path-grid path-grid-four">
  ...
  <a class="path-card" href="research/">
    ...
    <p>Browse six working research programs, 74 result pages, 20 open problems, and six dated manuscripts.</p>
    <span>Research →</span>
  </a>
</div>
...
**26 July 2026, Pacific time.** This draft publishes freshly compiled
version-8 editions of all six research manuscripts. All 301
program-relevant canonical records now have exact statement locations: 95 in
the existing theorem and discussion spines, and 206 in clearly labeled
supplementary catalogues of results, open problems, and corrections.
