...
### [JCG-292A9B9D · For multiplication-incidence opens from P^a x P^b, the next (2,3) candidate fails to have the affine-space class/count expected of A^5; the original (1,2) case is singled out within the stated incidence-coordinate class.](../claims/JCG-292A9B9D.md)
...
### [JCG-DBB38171 · A rank-three affine-linear family whose full simple-root incidence is affine three-space lies in the tangent-but-not-osculating orbit and recovers the base map up to left-right equivalence.](../claims/JCG-DBB38171.md)
...
### [JCG-06EFD647 · An affine-root incidence component of degree at least two cannot be A2, and a generically squarefree affine-linear projective coefficient family has no connected full simple-root incidence isomorphic to A2.](../claims/JCG-06EFD647.md)
...
### [JCG-517DA8F4 · Within the binary two-block multiplication-incidence construction U_{a,b,H}, stable affineness, and hence affineness, occurs only for the unordered pair {a,b}={1,2}.](../claims/JCG-517DA8F4.md)

Within the binary two-block multiplication-incidence construction U_{a,b,H}, stable affineness, and hence affineness, occurs only for the unordered pair {a,b}={1,2}.

*Defining · Primary Statement · Proof offered — review pending*

### [JCG-C5D74708 · The double-root resultant slice is affine three-space](../claims/JCG-C5D74708.md)
