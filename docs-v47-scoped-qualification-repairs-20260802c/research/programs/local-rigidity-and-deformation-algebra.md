...
- **5** result packages
- **1** open-problem packages
- **3** exact-coverage pages

</div>

## Model research brief

[Give a research model this one page](../handoffs/local-rigidity-and-deformation-algebra.md){ .md-button .md-button--primary }
...
Research state 29 July 2026 · 3267 words

## Current text proof sources

[Open the complete Program 3 TeX source](../proof-sources/03-local-rigidity/main.md){ .md-button .md-button--primary }
...
[Filtered Rigidity of the Degree-Seven Jacobian Counterexample, v13](../../assets/manuscripts/03-filtered-rigidity-2026-07-29-v13.pdf){ .md-button }

Nathaniel Monson · 22 pages · dated 2026-07-29 · SHA-256 `18f4658390d0a9566056aee505c3fb5039d17969368cb2f544a44e6ba956f427`
...
### [Formal Right Triviality And Degree Growth](../../collections/formal-right-triviality-and-degree-growth.md)
