...
Published SHA-256: `d4f2d80bc2f9bf5aaf431c2f094506ed7c9a07cc39daa08eded7ff2de2580946` · 42,415 bytes
...
- `lem:leading-image` — source line 596
<a id="label-prop-four-loci"></a>
- `prop:four-loci` — source line 654
<a id="label-rem-r-zero"></a>
- `rem:r-zero` — source line 701
<a id="label-sec-conic"></a>
- `sec:conic` — source line 726
<a id="label-eq-conic-form"></a>
- `eq:conic-form` — source line 730
<a id="label-lem-orbits"></a>
- `lem:orbits` — source line 736
<a id="label-lem-invariants"></a>
- `lem:invariants` — source line 776
<a id="label-eq-tab"></a>
- `eq:TAB` — source line 831
<a id="label-eq-chain"></a>
- `eq:chain` — source line 844
<a id="label-eq-divisibility"></a>
- `eq:divisibility` — source line 872
<a id="label-prop-terminal-conic"></a>
- `prop:terminal-conic` — source line 899
<a id="label-sec-degree-seven-escape"></a>
- `sec:degree-seven-escape` — source line 967
<a id="label-sec-computation"></a>
- `sec:computation` — source line 991
<a id="label-sec-open-degree-four"></a>
- `sec:open-degree-four` — source line 1071
<a id="label-rem-leaf-accounting"></a>
- `rem:leaf-accounting` — source line 1080
