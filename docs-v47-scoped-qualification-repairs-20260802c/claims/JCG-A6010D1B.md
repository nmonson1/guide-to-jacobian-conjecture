...
- `sec:kuranishi` in `papers-release-2026-07-26-v8/03-local-rigidity/main.tex` (exact version-8 statement)
- `prop:pure-weight` in `papers-release-2026-07-26-v8/03-local-rigidity/main.tex` (exact version-8 statement)
- `thm:reduced` in `papers-release-2026-07-26-v8/03-local-rigidity/main.tex` (exact version-8 statement)
