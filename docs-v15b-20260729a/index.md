...
!!! warning "Working draft"
    ...
    unrefereed working manuscripts and may contain errors. Every page is currently
...
<div class="path-grid path-grid-four">
  ...
  <a class="path-card" href="research/">
    ...
    <p>Browse six working research programs, 83 result packages, 19 open-problem packages, 355 tagged claims, and six dated manuscripts.</p>
    <span>Research →</span>
  </a>
</div>
...
The main navigation is written for readers. Beneath it is one stable-tag claim
graph: atomic claims, grouped result and problem packages, six programs, papers,
and proof-access records all render from the same data. Each claim page keeps
statement version, credit, evidence, manuscript coverage, and independent
review separate. Claims are searchable without turning the navigation into a
ledger.
...
**29 July 2026, Pacific time.** This candidate incorporates the complete
376-record private graph into a sanitized 355-claim public graph, expands the
catalogue to 102 grouped packages and 500 memberships, and publishes version 11
of the six reader manuscripts. Eight new packages cover cubic resolvent defects,
quartic ramification, local reconstruction, categorical quotients, homogeneous
compression, and a stored plane-boundary terminal model. Forty-two older
records whose grouping changed remain visibly marked for exact-locator audit.
