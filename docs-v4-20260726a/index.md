...
**26 July 2026, Pacific time.** This draft incorporates the final six review
threads, expands the sanitized catalogue to 94 theorem-level pages, and
publishes freshly compiled version-7 editions of all six research manuscripts.
