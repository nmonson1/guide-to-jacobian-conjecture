...
The generator performs no algebraic simplification. It only translates Python's
``**`` exponent notation to Macaulay2's ``^`` notation and preserves every
rational coefficient from the hash-checked public artifact.
"""
