...
compositions of elementary shears or wild source automorphisms.
...
weight-preserving family. The final pair combines the expanded 81-case finite
certificate with the weight-separation proof.
...
every single elementary monomial source shear.
...
The remaining Lane 5 gap is therefore not a single elementary shear. It is
closure under arbitrary compositions and the possible wild part of
`Aut(k[x,y,z])`.
