...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/03-local-rigidity/main.tex#def:slice`
...
- **source assertion:** theorem and exact-computation proof — `manuscripts/03-local-rigidity/appendices/source-flow-reconstruction-progress.tex#thm:source-flow-reconstruction`
  - Does not establish: The locator alone is not an independent proof review.
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/03-local-rigidity/appendices/degree-eight.tex#thm:degree-eight-transverse`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
- `uses` `RMU-2B8185BE`: Formal statement references def:slice.

Support:

- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/03-local-rigidity/main.tex#thm:main`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/03-local-rigidity/appendices/root-coordinate-source-flow.tex#q:different-filtered-reconstruction`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
- `uses` `RMU-276143E2`: Formal statement references prop:root-coordinate-divergence.

Support:

- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/03-local-rigidity/main.tex#q:source-flow-verifier`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/03-local-rigidity/appendices/border-basis-and-betti.tex#q:rational-betti`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
### [Third-order failure of the deterministic rank-six section is not intrinsic](../units/RMU-5A110522.md)
