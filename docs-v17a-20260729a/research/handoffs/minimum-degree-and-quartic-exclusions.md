...
<p class="handoff-snapshot"><strong>Snapshot:</strong> 29 July 2026 · 368 public claim records · 104 grouped packages · manuscripts v13 · handoff source v8 · site release <code>living-guide-public-v17a-coherent-handoffs</code>. <a href="release.json">Machine-readable release</a>.</p>
