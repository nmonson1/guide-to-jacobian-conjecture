...
Proof hardening of the existing fixed-frame Torelli chain remains valuable,
especially at empty boundary schemes, common roots, projective incidence,
and categorical-support steps. Exact formula checks do not replace those
geometric arguments.
...
1. independently harden the fixed-frame classification chain;
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/04-stable-moduli/appendices/general-boundary-residues.tex`
...
- **source assertion:** proposition — `manuscripts/04-stable-moduli/appendices/categorical-boundary-quotient.tex#prop:bounded-root-translation-groupoid`
  - Does not establish: The locator alone is not an independent proof review.
...
- **source assertion:** invariant-algebra theorem and proof — `manuscripts/04-stable-moduli/appendices/categorical-boundary-quotient.tex#thm:categorical-differential-kernel`
  - Does not establish: The locator alone is not an independent proof review.
- **source assertion:** one-wall theorem and corrected proof — `manuscripts/04-stable-moduli/appendices/categorical-boundary-quotient.tex#thm:one-wall-control`
  - Does not establish: The locator alone is not an independent proof review.
...
- **source assertion:** theorem and proof — `manuscripts/04-stable-moduli/appendices/categorical-boundary-quotient.tex#thm:fppf-wall-nonalgebraic`
  - Does not establish: The locator alone is not an independent proof review.
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/04-stable-moduli/appendices/general-boundary-residues.tex#cor:large-stable-moduli`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/04-stable-moduli/appendices/all-multiplicity-relative-jacobian.tex#lem:common-factor-multiplicity`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/04-stable-moduli/appendices/categorical-boundary-quotient.tex#prop:bounded-root-translation-groupoid`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
### [Formal-local versus stable separation](../units/RMU-DA627F3E.md)

`RMU-DA627F3E` · `proposition`

All \(q\)-arcs have the same first-order formal tangent and are
source-trivial through the three computed formal orders, while their
punctured fibers remain pairwise stably inequivalent.  Thus the stable
conductor modulus is invisible to this local formal data.
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/04-stable-moduli/main.tex#thm:main`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
For every \(n\ge2\), the cubic frame contains a
\((2n-3)\)-dimensional family of pairwise stably inequivalent
generic-degree-three Keller maps of ordinary degree \(4n+3\).
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/04-stable-moduli/main.tex`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
...
- **source assertion:** The manuscript records this exact formal statement. — `manuscripts/04-stable-moduli/main.tex#q:compactified-stable-moduli`
  - Does not establish: Presence in the manuscript is not an independent proof audit.
