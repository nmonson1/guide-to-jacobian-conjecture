...
-\beta d^2\xi^2.
\]
The first numerator is divisible by \(x^2\), and the second by \(x\);
this follows directly on substituting
\(\xi=1+xy\) and \(d=2-3xy-x^2z\).  Thus \(a\) and \(b\) are polynomial.
