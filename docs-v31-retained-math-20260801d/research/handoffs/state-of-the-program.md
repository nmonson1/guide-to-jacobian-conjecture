...
**July 30 import.** The intake adds 29 records spanning audits, degrees
five/six, Program 5 coupling, and Program 9. Checks replay;
Program 5 v3 inputs are missing. PR 1 recovers the Program 9/6 packet (38
tests), not the complete-chain subgroup. No theorem promotion. Next:
source-to-claim reconciliation. Recovered packets:
...
separately recovers filtered-operation/Program 6 tooling (38 tests pass) and
upper/lower-face diagnostics, but neither complete-chain admissibility nor
global attachment.
[Exact Program 6 frontier](../../research/handoffs/plane-boundary-obstructions.md#4-the-live-frontier).
