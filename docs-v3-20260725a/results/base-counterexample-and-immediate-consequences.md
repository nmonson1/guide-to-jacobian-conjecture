...
The theorem-level package is centered on the following mechanism: The displayed Alpöge polynomial map has Jacobian determinant equal to the constant -2.  Its supporting records isolate the ingredients that establish the statement and the qualifications that control its scope.
...
[Open the deeper technical record](../technical/technical-claim-015f97ff.md)
...
[Open the deeper technical record](../technical/technical-claim-c4dfaf31.md)
...
*Shared · Strengthening · proof offered*
