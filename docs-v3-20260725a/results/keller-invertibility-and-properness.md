...
**Credited to The Stacks Project Authors (properness reference); Zbigniew Jelonek (nonproperness theorem).**
...
The theorem-level package is centered on the following mechanism: For a Keller map over the complex numbers, polynomial invertibility, properness, emptiness of the nonproperness set, and codimension at least 2 of that set are equivalent, with the empty set assigned infinite codimension.  Its supporting records isolate the ingredients that establish the statement and the qualifications that control its scope.
...
**Evidence present:** literature result.
...
- The Stacks Project Authors: properness reference; documented authorship — the properness input cited by the source note
- Zbigniew Jelonek: nonproperness theorem; documented authorship — the hypersurface theorem used in the properness equivalence
