---
title: "Text proof source — 05-homogeneous-descendants/main.tex"
description: "Sanitized current source with exact labels when present."
---

# Text proof source

`manuscripts/05-homogeneous-descendants/main.tex`
...
Published SHA-256: `22da9f03720db8cec4dbfa89b45301c19a4170dbbc04ed595625bb85c42bf6ef` · 25,425 bytes

## Exact label anchors

<a id="label-sec-introduction"></a>
- `sec:introduction` — source line 49
<a id="label-thm-intro-suspension"></a>
- `thm:intro-suspension` — source line 96
<a id="label-thm-intro-fixed"></a>
- `thm:intro-fixed` — source line 108
<a id="label-thm-intro-obstruction"></a>
- `thm:intro-obstruction` — source line 122
<a id="label-sec-suspension"></a>
- `sec:suspension` — source line 137
<a id="label-eq-stable-map"></a>
- `eq:stable-map` — source line 151
<a id="label-lem-stable-identity"></a>
- `lem:stable-identity` — source line 157
<a id="label-eq-homogeneous-suspension"></a>
- `eq:homogeneous-suspension` — source line 176
<a id="label-eq-schur"></a>
- `eq:schur` — source line 196
<a id="label-sec-fixed-tensor"></a>
- `sec:fixed-tensor` — source line 225
<a id="label-eq-h19"></a>
- `eq:H19` — source line 263
<a id="label-eq-v1"></a>
- `eq:v1` — source line 294
<a id="label-eq-v2"></a>
- `eq:v2` — source line 297
<a id="label-prop-jordan19"></a>
- `prop:jordan19` — source line 301
<a id="label-eq-long-chain"></a>
- `eq:long-chain` — source line 315
<a id="label-sec-compression"></a>
- `sec:compression` — source line 338
<a id="label-eq-d4"></a>
- `eq:D4` — source line 354
<a id="label-eq-lambda4"></a>
- `eq:Lambda4` — source line 369
<a id="label-prop-compression"></a>
- `prop:compression` — source line 373
<a id="label-prop-target-cleanup"></a>
- `prop:target-cleanup` — source line 407
<a id="label-sec-hessian"></a>
- `sec:hessian` — source line 423
<a id="label-eq-q38"></a>
- `eq:Q38` — source line 448
<a id="label-prop-hessian-jordan"></a>
- `prop:hessian-jordan` — source line 459
<a id="label-eq-inverse-ray-g"></a>
- `eq:inverse-ray-G` — source line 517
<a id="label-eq-inverse-ray-q"></a>
- `eq:inverse-ray-Q` — source line 524
<a id="label-thm-laplacian"></a>
- `thm:laplacian` — source line 541
<a id="label-sec-pairing"></a>
- `sec:pairing` — source line 570
<a id="label-eq-waring"></a>
- `eq:waring` — source line 578
<a id="label-eq-dimw"></a>
- `eq:dimW` — source line 596
<a id="label-prop-waring52"></a>
- `prop:waring52` — source line 620
<a id="label-eq-pair-data"></a>
- `eq:pair-data` — source line 675
<a id="label-prop-pair110"></a>
- `prop:pair110` — source line 687
<a id="label-cor-pair-interval"></a>
- `cor:pair-interval` — source line 717
<a id="label-sec-computation"></a>
- `sec:computation` — source line 731
<a id="label-sec-questions"></a>
- `sec:questions` — source line 774
<a id="label-q-min-homogeneous-dimension"></a>
- `q:min-homogeneous-dimension` — source line 777
<a id="label-q-intrinsic-ranks"></a>
- `q:intrinsic-ranks` — source line 793
...
\input{appendices/full-kernel-and-compression-progress}
