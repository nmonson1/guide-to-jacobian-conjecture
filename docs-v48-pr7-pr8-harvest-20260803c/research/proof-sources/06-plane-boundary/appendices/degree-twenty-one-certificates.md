...
Published SHA-256: `cd98b91ee7b0a9f263d0cf3b9da756e4e040bc5418364351e49cdb80bc3aa666` · 20,422 bytes
...
- `prop:k4-chart-transition` — source line 387
<a id="label-thm-stored-terminal-layer-seven"></a>
- `thm:stored-terminal-layer-seven` — source line 442
...
architecture.  The certificate proves its displayed stored system; its
attachment to the full-support queue remains an open theorem.
~~~
