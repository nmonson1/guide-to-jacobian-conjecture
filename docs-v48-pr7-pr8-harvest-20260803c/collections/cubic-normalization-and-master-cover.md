...
!!! info "Stronger current result"
    A [stronger current unit](../research/working-mathematics/units/RMU-1A8D0001.md) is available.
...
### [JCG-248AD7B9 · Replaced historical record](../claims/JCG-248AD7B9.md)

!!! warning "Replaced working statement"
    The historical wording is suppressed here. Use the [current replacement](../research/working-mathematics/units/RMU-1A8D0001.md).
...
### [JCG-AB57A9B2 · Replaced historical record](../claims/JCG-AB57A9B2.md)

!!! warning "Replaced working statement"
    The historical wording is suppressed here. Use the [current replacement](../research/working-mathematics/units/RMU-1A8D0004.md).
...
### [JCG-26FD089B · A generically degree-three Keller map admits a useful normalization picture: a finite normalization X over the target together with an open embedding of A3, expressible through a finite-flat binary-cubic model.](../claims/JCG-26FD089B.md)
...
### [JCG-A5938472 · Replaced historical record](../claims/JCG-A5938472.md)
...
### [JCG-ECD1CA4E · The resultant-one factor space is isomorphic to SL2 times A1_gamma, and its universal marked-root map to the simple-root binary-cubic locus is etale; ordering the roots gives an S3 torsor.](../claims/JCG-ECD1CA4E.md)
...
### [JCG-BD8A0F77 · Replaced historical record](../claims/JCG-BD8A0F77.md)

!!! warning "Replaced working statement"
    The historical wording is suppressed here. Use the [current replacement](../research/working-mathematics/units/RMU-1A8D0003.md).
...
### [JCG-2E563312 · If the cubic normalization is flat, it is the pullback of the universal marked-root master cover; equality with affine three-space additionally requires completeness of the boundary deletion.](../claims/JCG-2E563312.md)
