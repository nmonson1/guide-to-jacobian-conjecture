---
title: "For every product of evaluations at two distinct points, the quadratic target hypersurface A2+kappa E_xi E_eta=c is isomorphic to A3, but its full marked-root preimage is never A3; its compactly supported Euler characteristic is never one."
...
<p class="claim-tag">JCG-BBB01109</p>
...
- [Quadratic Covariant Rigidity in the Cubic Incidence Construction](../collections/quadratic-covariant-incidence-rigidity.md) — defining, primary statement
...
- `thm:two-evaluation-exclusion` in `papers-release-2026-07-26-v8/01-cubic-incidence/appendices/quadratic-covariant-rigidity.tex` (exact version-8 statement)
