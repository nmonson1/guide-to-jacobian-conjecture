...
The six programs are working mathematical manuscripts, not refereed papers. Each summary states the current proof boundary and links a dated, versioned PDF.
