...
Geometric fibers of the displayed Alpöge map over complex points.
...
- [Image and nonproperness set of the counterexample](counterexample-image-and-nonproperness.md)
...
- Event: [The first geometric fiber-count description is corrected](../chronology-v2.md#event-jcg-e-0019)
