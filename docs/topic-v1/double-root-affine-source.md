...
### [The double-root resultant slice is affine three-space](../claim-v3/double-root-resultant-slice-affine-three-space.md)
...
### [Three symmetry orbits of dual binary-cubic hyperplanes](../claim-v3/binary-cubic-hyperplane-orbits.md)
...
### [Comparison with Vitushkin's 1999 rational example](../claim-v3/vitushkin-rational-example-comparison.md)
