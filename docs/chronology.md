...
| `JCG-C-0003` | Rodríguez Díaz, *On the origin of the Jacobian conjecture* | 5 Jun 2026 | Refereed publication | `JCG-CLAIM-0010`–`0011` |
| `JCG-C-0004` | Formal Conjectures PR 4474 | 20 Jul 2026 | Open pull request | `JCG-CLAIM-0004` |
| `JCG-C-0005` | Standalone all-field Lean development | 20 Jul 2026 | Public repository | `JCG-CLAIM-0012` |
| `JCG-C-0006` | MathOverflow Galois/deck-group analysis | 20 Jul 2026 | Closed question; working analysis | `JCG-CLAIM-0013`–`0014` |
| `JCG-C-0007` | *Weighted lifts from the Jacobian counterexample* | 20 Jul 2026 | Public repository note | `JCG-CLAIM-0008` |
| `JCG-C-0008` | Explicit degree-three map in 11 variables | 20 Jul 2026 | Public executable gist | `JCG-CLAIM-0015` |
| `JCG-C-0009` | *Direct consequences…* | 20 Jul 2026 | Public web note | `JCG-CLAIM-0016`–`0018` |
| `JCG-C-0010` | *The Dixmier conjecture fails for (A_n), (nge3)* | 21 Jul 2026 | Public working note | `JCG-CLAIM-0019` |
| `JCG-C-0011` | *Small Counterexamples to the Gaussian Moments Conjecture* | 20 Jul 2026 | arXiv v1 | `JCG-CLAIM-0020` |
| `JCG-C-0012` | Formal Conjectures PR 4486 | 21 Jul 2026 | Closed, unmerged pull request | `JCG-CLAIM-0004` |
| `JCG-C-0013` | Explicit cubic-homogeneous map in 24 variables | 21 Jul 2026 | Public repository and archive | `JCG-CLAIM-0021` |
...
- The cited MathOverflow page for an independent all-degree family is currently
  deleted. The all-degree record instead relies on the Ulam note and the pinned
  JacobianFun construction.
- The (S_3) and trivial-deck-group statements remain working claims: their
  MathOverflow post asks for correctness checking, has no answer, and was closed.
- Public papers, scripts, and Lean code count as evidence present. No named
  project assessment has yet been published.
