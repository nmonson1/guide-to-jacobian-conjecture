...
- `related_to` [`JCG-F299193A`](../units/JCG-F299193A.md): This local calculation narrows the retained open basepoint-boundary problem to nontransverse, higher-length, and global-gluing cases.
