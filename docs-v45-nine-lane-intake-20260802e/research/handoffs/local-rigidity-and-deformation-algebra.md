...
<p class="claim-tag">Program 3 · Updated 2 August 2026</p>
...
[Retained working mathematics](../working-mathematics/programs/local-rigidity-and-deformation-algebra.md) · [Current proof sources](../proof-sources/03-local-rigidity/main.md) · [Machine-readable release metadata](release.json)
