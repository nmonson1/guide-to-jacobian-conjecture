---
title: "Text proof source — 03-local-rigidity/appendices/source-flow-reconstruction-progress.tex"
description: "Sanitized current source with exact labels when present."
---

# Text proof source

`manuscripts/03-local-rigidity/appendices/source-flow-reconstruction-progress.tex`
...
Published SHA-256: `b58643ac22d41942713bb8b18dae83172fd84013456b21b44eb93965024a257e` · 5,789 bytes

## Exact label anchors

<a id="label-app-source-flow-reconstruction-progress"></a>
- `app:source-flow-reconstruction-progress` — source line 2
<a id="label-thm-source-flow-reconstruction"></a>
- `thm:source-flow-reconstruction` — source line 42
<a id="label-cor-source-flow-reduced-rigidity"></a>
- `cor:source-flow-reduced-rigidity` — source line 85
<a id="label-prop-source-flow-order-five"></a>
- `prop:source-flow-order-five` — source line 108
