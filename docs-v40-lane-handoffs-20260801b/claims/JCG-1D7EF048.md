---
title: "Cubic Keller Maps Have Only the U1, U2, and B Divisorial Types"
description: "For a complex generic-degree-three Keller map, every target prime divisor has a retained unramified sheet and hence only the U1, U2, or B deleted-sheet type; a deleted three-cycle is impossible, and the generic monodromy is S3."
---

<p class="claim-tag">JCG-1D7EF048</p>
# Cubic Keller Maps Have Only the U1, U2, and B Divisorial Types
...
!!! warning "Superseded by current working mathematics"
    ...
    [current corrected unit](../research/working-mathematics/units/RMU-C1DD871B.md)
...
- [Base Cover Monodromy And Deck Group](../collections/base-cover-monodromy-and-deck-group.md) — shared, generalization
- [Resolvent Restrictions on a Cubic Normalization Defect](../collections/cubic-resolvent-defect-exclusions.md) — defining, supporting result
...
- `prop:cubic-divisorial-trichotomy` in `manuscripts/01-cubic-incidence/appendices/cubic-resolvent-defects.tex` (theorem and proof)
