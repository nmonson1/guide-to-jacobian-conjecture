...
- `strengthens` `RMU-5A110523`: The earlier retained unit handled one selected plane at a rational slope; this classifies every finite slope in the selected plane through the first intrinsic obstruction.
