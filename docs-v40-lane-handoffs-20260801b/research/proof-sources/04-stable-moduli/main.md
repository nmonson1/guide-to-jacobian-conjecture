...
Published SHA-256: `1cc8cba6d91b6a84346afc6c80957d4aa15fc3488775990729f3a74378eaa24a` · 30,011 bytes

## Exact label anchors

<a id="label-sec-introduction"></a>
- `sec:introduction` — source line 55
<a id="label-eq-ab-general"></a>
- `eq:AB-general` — source line 132
<a id="label-thm-main"></a>
- `thm:main` — source line 142
<a id="label-sec-family"></a>
- `sec:family` — source line 204
<a id="label-eq-frame"></a>
- `eq:frame` — source line 208
<a id="label-eq-g-frame"></a>
- `eq:G-frame` — source line 219
<a id="label-prop-basic"></a>
- `prop:basic` — source line 235
<a id="label-eq-fiber-cubic-general"></a>
- `eq:fiber-cubic-general` — source line 292
<a id="label-eq-reconstruct"></a>
- `eq:reconstruct` — source line 302
<a id="label-eq-diagonal-equivalence"></a>
- `eq:diagonal-equivalence` — source line 329
<a id="label-eq-ab-normalized"></a>
- `eq:AB-normalized` — source line 345
<a id="label-sec-nonproperness"></a>
- `sec:nonproperness` — source line 350
<a id="label-eq-cylinder-np"></a>
- `eq:cylinder-NP` — source line 357
<a id="label-eq-delta"></a>
- `eq:Delta` — source line 369
<a id="label-prop-np"></a>
- `prop:NP` — source line 389
<a id="label-sec-normalization"></a>
- `sec:normalization` — source line 454
<a id="label-eq-normalization-map"></a>
- `eq:normalization-map` — source line 459
<a id="label-eq-hq"></a>
- `eq:Hq` — source line 471
<a id="label-prop-normalization"></a>
- `prop:normalization` — source line 476
<a id="label-eq-t-relation-1"></a>
- `eq:t-relation-1` — source line 487
<a id="label-eq-t-relation-2"></a>
- `eq:t-relation-2` — source line 488
<a id="label-eq-recover-t"></a>
- `eq:recover-t` — source line 503
<a id="label-eq-grad-a"></a>
- `eq:grad-a` — source line 512
<a id="label-eq-grad-b"></a>
- `eq:grad-b` — source line 513
<a id="label-eq-grad-c"></a>
- `eq:grad-c` — source line 515
<a id="label-eq-m-map"></a>
- `eq:M-map` — source line 527
<a id="label-eq-marked-pair"></a>
- `eq:marked-pair` — source line 542
<a id="label-lem-marked-rigidity"></a>
- `lem:marked-rigidity` — source line 548
<a id="label-eq-c-form"></a>
- `eq:C-form` — source line 564
<a id="label-eq-h-pull"></a>
- `eq:H-pull` — source line 571
<a id="label-eq-mu"></a>
- `eq:mu` — source line 587
<a id="label-eq-constant-comparison"></a>
- `eq:constant-comparison` — source line 595
<a id="label-thm-stable-nonexceptional"></a>
- `thm:stable-nonexceptional` — source line 604
<a id="label-sec-exceptional"></a>
- `sec:exceptional` — source line 634
<a id="label-prop-exceptional"></a>
- `prop:exceptional` — source line 648
<a id="label-cor-q-classification"></a>
- `cor:q-classification` — source line 686
<a id="label-sec-alpha-zero"></a>
- `sec:alpha-zero` — source line 700
<a id="label-eq-theta"></a>
- `eq:Theta` — source line 714
<a id="label-eq-ell-delta"></a>
- `eq:ell-delta` — source line 729
<a id="label-eq-xi"></a>
- `eq:Xi` — source line 735
<a id="label-prop-alpha-zero-gauge"></a>
- `prop:alpha-zero-gauge` — source line 745
<a id="label-prop-zero-vs-nonzero"></a>
- `prop:zero-vs-nonzero` — source line 773
<a id="label-sec-verification"></a>
- `sec:verification` — source line 799
<a id="label-sec-questions"></a>
- `sec:questions` — source line 852
<a id="label-q-compactified-stable-moduli"></a>
- `q:compactified-stable-moduli` — source line 879
...
from the recovered source artifact.  Independent implementation and
specialist review remain submission requirements.}
\end{center}
...
These computations verify the displayed polynomial identities.  They do not
replace the geometric arguments that the nonproperness divisor is intrinsic,
that normalization lifts an isomorphism, or that the two marked curves are
recovered as asserted.  Those are conventional proofs in
\cref{sec:nonproperness,sec:normalization}.  A genuinely independent CAS
implementation and expert review of the stable-cylinder argument remain
release gates.
...
\cref{sec:verification}, not the output of a language model.  Human
specialist review has not yet been completed.
