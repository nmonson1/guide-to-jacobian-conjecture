...
six working research programs, 85 result collections, and 19 open-problem collections.
...
The public pages are generated deterministically from the sanitized publication
layer selected by `site-state.json`. Human-written exposition may
...
- [The state of the research program](research/index.md)
- [The stable-tag claim catalogue](results/all-claims.md)
