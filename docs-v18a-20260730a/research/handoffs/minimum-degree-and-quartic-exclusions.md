...
<p class="handoff-snapshot"><strong>Snapshot:</strong> 30 July 2026 · 368 public claim records · 104 grouped packages · manuscripts v13 · handoff source v9 · site release <code>living-guide-public-v18a-companion-budget-handoffs</code>.</p>
...
There is also a second-Chern-character point-defect identity. In the quartic
span-two setup these imply `H >= 4` and finitely many equality profiles. The
...
Use this in P2-T2/T3 as an alternative derivation and consistency check. It
