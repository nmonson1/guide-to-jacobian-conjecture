...
The theorem-level package is centered on the following mechanism: The Jacobian conjecture is false in every dimension n at least 3.  Its supporting records isolate the ingredients that establish the statement and the qualifications that control its scope.
