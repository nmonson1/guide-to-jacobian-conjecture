...
A weighted transverse slice reduces the calculation to ten parameters.  Exact Kuranishi equations define a finite local Artin algebra; its Hilbert function, inverse system, socle, and minimal equations encode the residual scheme-theoretic multiplicity.

## Scope and current boundary

The claims concern a specified bounded-degree quotient and do not rule out degree-increasing or unrestricted polynomial deformations. The exact computations are internally reproduced but need an independent computer-algebra implementation and expert review.

## Working manuscript

[Download the versioned PDF](../../assets/manuscripts/03-filtered-rigidity-2026-07-22-v1.pdf){ .md-button .md-button--primary }

Nathaniel Monson · manuscript dated 2026-07-22 · 16 pages · SHA-256 `dfc2958a1ab5e8bb64d1b2e20a98d42f0a5e65bb6327cce12916d6b0bf18226e`

This PDF is a research manuscript, not a compendium of every catalogue entry assigned to the program. Current page-level coverage: locator audit needed 1, partial 4.
