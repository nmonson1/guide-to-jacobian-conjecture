...
<p class="dek">Six questions opened by the counterexample, followed by the complete public catalogue of 71 results and 16 open problems.</p>

The six programs are working mathematical manuscripts, not refereed papers. The catalogue is newer and broader than the PDFs. Every result page therefore states whether its linked PDF is complete, partial, absent, or still awaiting an exact locator audit.
...
[Read the program](research/programs/cubic-marked-root-incidence-geometry.md) · [PDF, v1](assets/manuscripts/01-cubic-marked-root-covers-2026-07-22-v1.pdf)
...
[Read the program](research/programs/minimum-degree-and-quartic-exclusions.md) · [PDF, v1](assets/manuscripts/02-quartic-keller-maps-2026-07-22-v1.pdf)
...
[Read the program](research/programs/local-rigidity-and-deformation-algebra.md) · [PDF, v1](assets/manuscripts/03-filtered-rigidity-2026-07-22-v1.pdf)
...
[Read the program](research/programs/stable-moduli.md) · [PDF, v1](assets/manuscripts/04-boundary-rigidity-stable-moduli-2026-07-22-v1.pdf)
...
[Read the program](research/programs/homogeneous-descendants.md) · [PDF, v1](assets/manuscripts/05-homogeneous-descendants-2026-07-22-v1.pdf)
...
[Read the program](research/programs/plane-boundary-obstructions.md) · [PDF, v1](assets/manuscripts/06-plane-boundary-obstructions-2026-07-22-v1.pdf)
...
Generic lost-sheet behavior in this cubic-incidence setting separates into ramified U1, unramified U2, and boundary B models.
...
### [Six Sheet Plane Constraints](results/six-sheet-plane-constraints.md)

A hypothetical six-sheet counterexample to \(\mathrm{JC}_2\) must have monodromy \(A_6\) or \(S_6\).
...
In dimension five the possible generic Jordan types reduce to (5), (4,1), and (3,2), and a tested sparse support-at-most-four ansatz has no counterexample.
