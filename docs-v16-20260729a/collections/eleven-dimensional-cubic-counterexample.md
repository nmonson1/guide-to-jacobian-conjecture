...
<span class="status status-kind">Result</span> <span class="status status-draft">Public</span> <span class="status coverage-complete">Exact manuscript location</span>
