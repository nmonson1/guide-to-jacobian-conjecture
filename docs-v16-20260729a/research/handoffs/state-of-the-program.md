...
fixed-component calculations now replay; the sharp remaining branch is the
exceptional weighted-inflection `F_4` compatibility, whose missing formulas
must be re-derived from the Hilbert–Burch branch rather than guessed. In
...
| 4 | Program 2 `P2-T1` exceptional `F_4`, `P2-T2` case tree, `P2-T3` proof/code correspondence |
