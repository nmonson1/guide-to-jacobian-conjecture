...
Published SHA-256: `46ea91a846db08c38bd8d0d2af5781146a1a773b17f3fd25615243176cbf55fb` · 39,786 bytes

## Exact label anchors

<a id="label-sec-introduction"></a>
- `sec:introduction` — source line 72
<a id="label-thm-intro-primary"></a>
- `thm:intro-primary` — source line 119
<a id="label-thm-intro-secondary"></a>
- `thm:intro-secondary` — source line 222
<a id="label-sec-faces"></a>
- `sec:faces` — source line 267
<a id="label-eq-ambient-ode"></a>
- `eq:ambient-ode` — source line 284
<a id="label-eq-ambient-tau"></a>
- `eq:ambient-tau` — source line 289
<a id="label-prop-ambient-passport"></a>
- `prop:ambient-passport` — source line 294
<a id="label-eq-ambient-derivative"></a>
- `eq:ambient-derivative` — source line 297
<a id="label-eq-ambient-passport"></a>
- `eq:ambient-passport` — source line 302
<a id="label-thm-lattice-gap"></a>
- `thm:lattice-gap` — source line 370
<a id="label-eq-quotient-ode"></a>
- `eq:quotient-ode` — source line 389
<a id="label-eq-quotient-map"></a>
- `eq:quotient-map` — source line 395
<a id="label-eq-quotient-derivative"></a>
- `eq:quotient-derivative` — source line 400
<a id="label-eq-quotient-passport"></a>
- `eq:quotient-passport` — source line 406
<a id="label-sec-queue"></a>
- `sec:queue` — source line 440
<a id="label-tab-queue"></a>
- `tab:queue` — source line 474
<a id="label-prop-hurwitz-count"></a>
- `prop:hurwitz-count` — source line 478
<a id="label-prop-f2-map"></a>
- `prop:f2-map` — source line 514
<a id="label-eq-f2-map"></a>
- `eq:f2-map` — source line 527
<a id="label-eq-126-one"></a>
- `eq:126-one` — source line 552
<a id="label-eq-126-two"></a>
- `eq:126-two` — source line 572
<a id="label-eq-face-linearization"></a>
- `eq:face-linearization` — source line 599
<a id="label-prop-face-rigidity"></a>
- `prop:face-rigidity` — source line 619
<a id="label-sec-normal-complex"></a>
- `sec:normal-complex` — source line 655
<a id="label-eq-master"></a>
- `eq:master` — source line 661
<a id="label-prop-layer"></a>
- `prop:layer` — source line 676
<a id="label-eq-layer"></a>
- `eq:layer` — source line 680
<a id="label-prop-adjoint"></a>
- `prop:adjoint` — source line 700
<a id="label-eq-adjoint"></a>
- `eq:adjoint` — source line 703
<a id="label-eq-ibp"></a>
- `eq:ibp` — source line 717
<a id="label-prop-index"></a>
- `prop:index` — source line 735
<a id="label-eq-index"></a>
- `eq:index` — source line 746
<a id="label-sec-secondary"></a>
- `sec:secondary` — source line 772
<a id="label-eq-contact"></a>
- `eq:contact` — source line 780
<a id="label-eq-volume"></a>
- `eq:volume` — source line 787
<a id="label-eq-homogeneous"></a>
- `eq:homogeneous` — source line 795
<a id="label-lem-resonance"></a>
- `lem:resonance` — source line 800
<a id="label-eq-transport-equation"></a>
- `eq:transport-equation` — source line 817
<a id="label-prop-contact"></a>
- `prop:contact` — source line 824
<a id="label-eq-contact-degree"></a>
- `eq:contact-degree` — source line 846
<a id="label-thm-secondary"></a>
- `thm:secondary` — source line 878
<a id="label-eq-h-sum"></a>
- `eq:H-sum` — source line 890
<a id="label-eq-h-hypergeometric"></a>
- `eq:H-hypergeometric` — source line 892
<a id="label-eq-h-ode"></a>
- `eq:H-ode` — source line 896
<a id="label-eq-secondary-w"></a>
- `eq:secondary-W` — source line 906
<a id="label-eq-secondary-derivative"></a>
- `eq:secondary-derivative` — source line 911
<a id="label-eq-secondary-passport"></a>
- `eq:secondary-passport` — source line 917
<a id="label-cor-417"></a>
- `cor:417` — source line 956
<a id="label-sec-descent"></a>
- `sec:descent` — source line 971
<a id="label-lem-filtered"></a>
- `lem:filtered` — source line 977
<a id="label-q-integrable"></a>
- `q:integrable` — source line 1015
<a id="label-q-finite-determinacy"></a>
- `q:finite-determinacy` — source line 1029
<a id="label-q-splitting"></a>
- `q:splitting` — source line 1041
<a id="label-sec-computation"></a>
- `sec:computation` — source line 1049
...
special-fiber calculation.  A separate raw-support replay closes both
normalized \((8,28)\) support alternatives directly.  Combined with the
published Guccione--Guccione--Horruitiner--Valqui reduction, this gives no
plane Keller counterexample of maximum coordinate degree below \(125\).
No priority is claimed for that bound.  These results organize a terminal
...
complete all-coefficient proof \cite{santibanezLeal2026planar}.  We make no
novelty or priority claim for the degree-\(125\) bound.  Our
independent raw-support reconstruction and terminal calculation give a
separate proof assembly, stated with its exact imported dependencies in
\cref{cor:plane-degree-below-125}.  The broader purpose of this paper is to
extract reusable boundary theorems and to state exactly what remains missing
from a global argument.
...
\(5\le r\le11\).  The direct support closure in
\cref{thm:degree21-two-support-closure} uses the raw triangular recursion
instead.
...
interpretation as an exhaustive below-\(125\) obstruction uses the published
Newton-polygon reduction from an arbitrary hypothetical counterexample below
that bound to the two normalized supports used here.
...
those two supports through the terminal obstruction systems and closes both
roots; see \cref{thm:degree21-two-support-closure}.  Thus the missing utility
and the unattached adjacent-chart terminal are not dependencies of the
present certificate path.
