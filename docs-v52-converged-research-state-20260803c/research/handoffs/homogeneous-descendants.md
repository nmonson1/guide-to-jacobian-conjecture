...
[Open the current Homogeneous Descendants graph view](../working-mathematics/programs/homogeneous-descendants.md)
...
- [Lane 6: homogeneous realization compression](homogeneous-realization-compression.md)
