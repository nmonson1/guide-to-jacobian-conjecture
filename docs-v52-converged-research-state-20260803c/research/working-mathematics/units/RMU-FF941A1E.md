---
title: "For every \\(q\\in\\C\\), \\[ S_{G_q}=D_q\\cup P. \\] These are the two irreducible…"
description: "For every \\(q\\in\\C\\),\n\\[\nS_{G_q}=D_q\\cup P.\n\\]\nThese are the two irreducible components.  For \\(q\\ne-2\\), the component\n\\(D_q\\) is singular and \\(P\\) is smooth."
---

# For every \(q\in\C\), \[ S_{G_q}=D_q\cup P. \] These are the two irreducible…

`RMU-FF941A1E` · `proposition` · statement version `1`
