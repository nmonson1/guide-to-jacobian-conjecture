...
<span class="status status-kind">Open Problem</span> <span class="status coverage-partial">Partial manuscript locator</span>
...
### [JCG-44729E0B · Natural next problems include classification of generic-degree-three examples, bounded-degree…](../claims/JCG-44729E0B.md)

Natural next problems include classification of generic-degree-three examples, bounded-degree local moduli, minimum coordinate degree, nonproperness divisors, optimized cubic reduction, the plane case, and possible universality of the marked-root construction.

*Defining · Primary Statement · Open*

### [JCG-AF04161C · Top priorities are independent certificate reproduction, the full bounded-degree local ring a…](../claims/JCG-AF04161C.md)
...
### [JCG-48D5E369 · The highest-leverage program is exact reconstruction of the five Belyi maps followed…](../claims/JCG-48D5E369.md)
...
### [JCG-30AF091E · The minimal ordinary degree in dimension three, minimal homogeneous-reduction dimension, and…](../claims/JCG-30AF091E.md)
...
### [JCG-D9E57688 · Construct a different-filtered source-flow or transferred L-infinity model that independently…](../claims/JCG-D9E57688.md)
...
### [JCG-4451EE05 · For a realized decorated boundary class xi, bound the orbit-minimal ordinary degree…](../claims/JCG-4451EE05.md)
