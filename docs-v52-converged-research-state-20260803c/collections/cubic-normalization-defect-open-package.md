...
### [JCG-583DA94A · Normal cubic covers with S3 monodromy need not be flat: an explicit…](../claims/JCG-583DA94A.md)
...
- [Cubic flatness](../research/working-mathematics/units/RMU-34FBCB8D.md): Does the Keller condition force the finite cubic normalization
...
- [Completed defect branch and exact defective-fibre length](../research/working-mathematics/units/RMU-1A8D0005.md): At a point y in Supp(Delta_F), completion of the cubic normalization has one normal local factor of rank three. Its cubic fraction-field extension is non-Galois and therefore has S_3 Galois closure. If b is the presentation number from RMU-1A8D0001, then the finite normalization fibre is supported at one point and has scheme length b+3, hence at least four; length four is exactly the one-generator stratum.

*Defining · Partial Result · Recorded*

### [JCG-F9F6311C · At the first possible defect stratum the discriminant has multiplicity at least…](../claims/JCG-F9F6311C.md)
...
### [JCG-62422786 · No algebraically homogeneous minimal defect can occur in a Keller normalization.](../claims/JCG-62422786.md)

No algebraically homogeneous minimal defect can occur in a Keller normalization.

*Defining · Partial Result · Proof supplied*

### [JCG-D0FCE306 · The remaining minimal defect can be organized by a radial fibration and…](../claims/JCG-D0FCE306.md)
...
### [JCG-5716FF00 · Algebraize the formal/radial ruling strongly enough to exclude the remaining nonhomogeneous m…](../claims/JCG-5716FF00.md)
...
### [JCG-AB9F57D0 · Formal extension of the ruling can hold while Zariski-local algebraization of every…](../claims/JCG-AB9F57D0.md)
...
### [JCG-717B157D · In the stated marked-incidence deformation problem with smooth leading plane cubic, every…](../claims/JCG-717B157D.md)
...
### [JCG-A9379D6C · For the analyzed minimal smooth defect end, the local sign-three torsor group…](../claims/JCG-A9379D6C.md)
...
### [JCG-1C1790E5 · Show that at least one nonzero class in the local F_3^2 sign-torsor…](../claims/JCG-1C1790E5.md)
...
- [Dao's torsion exclusion and codimension-two detection](../research/working-mathematics/units/RMU-13177F24.md): Let \((Q,\mathfrak n)\) be a three-dimensional normal local hypersurface over
...
- [Exact comparison criterion](../research/working-mathematics/units/RMU-A4B084FF.md): In the quadratic-resolvent setup above, suppose there exists a rank-one
...
### [JCG-FD961DD5 · Assume a zero-dimensional log-canonical resolvent center admits the stated equivariant plt ex…](../claims/JCG-FD961DD5.md)
...
### [JCG-4D6F79C6 · Let L/K(lambda) be the cubic radial extension at the exceptional marked-root end,…](../claims/JCG-4D6F79C6.md)
