---
title: "Text proof source — 02-low-degree/appendices/quartic-high-ramification-and-fixed-components.tex"
description: "Sanitized current source with exact labels when present."
---

# Text proof source

`manuscripts/02-low-degree/appendices/quartic-high-ramification-and-fixed-components.tex`
...
Published SHA-256: `f4c20614a12e0f72870b1c8bbbd724f5e7e2eac51d8c822e748090ad166e7569` · 12,194 bytes

## Exact label anchors

<a id="label-app-quartic-high-ramification-fixed-components"></a>
- `app:quartic-high-ramification-fixed-components` — source line 2
<a id="label-thm-quartic-high-ramification"></a>
- `thm:quartic-high-ramification` — source line 35
<a id="label-prop-quartic-fourth-power-zero-minor"></a>
- `prop:quartic-fourth-power-zero-minor` — source line 99
<a id="label-lem-fixed-component-valuation"></a>
- `lem:fixed-component-valuation` — source line 148
<a id="label-cor-quartic-fixed-component-basepoint-valuation"></a>
- `cor:quartic-fixed-component-basepoint-valuation` — source line 182
<a id="label-thm-quartic-nonbinary-fixed-components"></a>
- `thm:quartic-nonbinary-fixed-components` — source line 211
<a id="label-thm-quartic-binary-fixed-factors"></a>
- `thm:quartic-binary-fixed-factors` — source line 260
<a id="label-cor-quartic-revised-frontier"></a>
- `cor:quartic-revised-frontier` — source line 333
