...
<p class="claim-tag">Program 6 · Updated 3 August 2026</p>
...
[Retained working mathematics](../working-mathematics/programs/plane-boundary-obstructions.md) · [Current proof sources](../proof-sources/06-plane-boundary/main.md) · [Machine-readable release metadata](release.json)
