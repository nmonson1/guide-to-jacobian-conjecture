...
matrices, truncated contradiction, and 15 full-support equations. Exact
leaves prove:
...
including its two JSON inputs and complete Python program; the three retained
units; and the linked terminal proof sources.
