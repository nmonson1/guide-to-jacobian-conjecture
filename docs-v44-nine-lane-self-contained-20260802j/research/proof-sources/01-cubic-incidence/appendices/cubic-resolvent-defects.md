---
title: "Text proof source — 01-cubic-incidence/appendices/cubic-resolvent-defects.tex"
description: "Sanitized current source with exact labels when present."
---

# Text proof source

`manuscripts/01-cubic-incidence/appendices/cubic-resolvent-defects.tex`
...
Published SHA-256: `e59bbc43525017395aaf75095e46219574218ada9e9080580a603f0824e7b2fb` · 8,685 bytes

## Exact label anchors

<a id="label-app-cubic-normalization-defect"></a>
- `app:cubic-normalization-defect` — source line 2
<a id="label-prop-cubic-divisorial-trichotomy"></a>
- `prop:cubic-divisorial-trichotomy` — source line 17
<a id="label-prop-corrected-divisorial-types"></a>
- `prop:corrected-divisorial-types` — source line 18
<a id="label-prop-resolvent-mcm-criterion"></a>
- `prop:resolvent-mcm-criterion` — source line 99
<a id="label-thm-dao-codim-two"></a>
- `thm:dao-codim-two` — source line 125
<a id="label-prop-smooth-axis-comparison"></a>
- `prop:smooth-axis-comparison` — source line 161
