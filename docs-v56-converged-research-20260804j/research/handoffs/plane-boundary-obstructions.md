...
<p class="claim-tag">Program 6 · Updated 4 August 2026</p>
...
[Open the current Plane Boundary Obstructions graph view](../working-mathematics/programs/plane-boundary-obstructions.md)
...
- [Lane 8: plane newton queue terminal certificates](plane-newton-queue-terminal-certificates.md)
- [Lane 9: plane chart correspondence global attachment](plane-chart-correspondence-global-attachment.md)
