---
title: "Normalized affine stabilizer"
description: "The stabilizer of \\(G\\) under \\eqref{eq:rho} is\n\\[\n\\operatorname{Stab}_{\\operatorname{Aff}_3}(G)\n=\\set{A_\\tau:\\tau\\in\\Gm}\\cong\\Gm.\n\\]"
---

# Normalized affine stabilizer

`RMU-4A713512` · `proposition` · statement version `1`
