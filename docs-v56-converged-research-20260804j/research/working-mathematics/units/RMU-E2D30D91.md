---
title: "Finite-root chart and weighted divisor"
description: "The \\(\\delta_a\\)-chart of \\(\\mathfrak B_D\\) is canonically\n\\(\\A^2_{c,t}\\).  On it,\n\\[\n\\mathfrak J\\mathcal O_{\\A^2}\n=\\bigl(\\rho(c)H_0(c,t)^3\\bigr).\n\\]"
---

# Finite-root chart and weighted divisor

`RMU-E2D30D91` · `proposition` · statement version `1`
