---
title: "Three-variable cubic-factor quintics"
description: "Let \\(G\\) be a squarefree cubic genuinely depending on \\(x,y,z\\).  There is\nno Keller jet with leading form\n\\[\nG(x,y,z)(x^2,xy,y^2).\n\\]\nThus the only unresolved cubic-factor overlap of this shape is the binary\ncase \\(G\\in\\C[x,y]\\)."
---

# Three-variable cubic-factor quintics

`RMU-9A886B47` · `theorem` · statement version `1`
