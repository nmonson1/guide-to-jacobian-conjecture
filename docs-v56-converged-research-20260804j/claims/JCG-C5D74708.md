...
- `supp-note-01-003` in `papers-release-2026-07-26-v8/01-cubic-incidence/appendices/additional-results-and-leads.tex` (version-8 supplementary statement with explicit evidence boundary)
...
[Open the full mathematical unit](../research/working-mathematics/units/JCG-C5D74708.md)
