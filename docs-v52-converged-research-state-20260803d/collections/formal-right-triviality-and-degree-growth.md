...
### [JCG-30FC31CC · Every formal polynomial Keller deformation of the fixed map is right-trivial as…](../claims/JCG-30FC31CC.md)

Every formal polynomial Keller deformation of the fixed map is right-trivial as F composed with a formal source automorphism; bounded-degree obstructions come from the degree filtration, not unrestricted formal deformation theory.

*Defining · Primary Statement · Proof supplied*

### [JCG-41FFDBEF · For any Keller map F, the first-order kernel of the determinant equation…](../claims/JCG-41FFDBEF.md)
...
### [JCG-B3286203 · The family is formally conjugate coefficient by coefficient while no conjugacy of…](../claims/JCG-B3286203.md)
