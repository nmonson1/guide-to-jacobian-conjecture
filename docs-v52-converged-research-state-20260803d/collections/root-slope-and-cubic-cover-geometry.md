...
### [JCG-0106262F · For any polynomial potential H(T,c), the marked-root and slope equations b=r-H_T(t,c), 2a=H(t…](../claims/JCG-0106262F.md)

For any polynomial potential H(T,c), the marked-root and slope equations b=r-H_T(t,c), 2a=H(t,c)+tb have Jacobian r/2; composing with t=y+1/x, r=2/x, c=w(x,y)-x^3z has Jacobian -2 whenever the formulas extend polynomially, and generic degree deg_T H.

*Defining · Primary Statement · Recorded*

### [JCG-ADA71038 · On a sheet marked by a simple root t_i of a cubic,…](../claims/JCG-ADA71038.md)
...
### [JCG-8EF344E1 · Over A(c) nonzero, the normalized cubic discriminant complement is the product of…](../claims/JCG-8EF344E1.md)
...
### [JCG-5B09E55B · For every coprime admissible cubic-frame pair, the generic function-field extension has no…](../claims/JCG-5B09E55B.md)
